    ...
    class MethodRunner implements Runnable {
        ...
        public void run() {
            try {
                ...
                // Never convert a storage error into a wipe, success, or missing value.
                handleException(e);
            }
        }

        private void handleException(Exception e) {
            // Do not expose provider exceptions, aliases, ciphertext or stack traces.
            result.error("secure_storage_unavailable", "Secure storage is unavailable. Retry after unlocking the device.", null);
        }
    }
}
