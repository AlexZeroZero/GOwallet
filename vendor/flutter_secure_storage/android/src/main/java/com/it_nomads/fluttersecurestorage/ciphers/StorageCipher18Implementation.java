    ...
    public StorageCipher18Implementation(Context context, KeyCipher rsaCipher) throws Exception {
        ...
        if (aesKey != null) {
            ...
            try {
                ...
                // Replacing a temporarily inaccessible key destroys access to old values.
                throw new java.security.GeneralSecurityException("Stored key cannot be unwrapped", e);
            }
        }
        ...
        if (!editor.commit()) throw new java.io.IOException("Key persistence failed");
    }
