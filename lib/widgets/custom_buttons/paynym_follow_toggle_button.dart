      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "You are following {0}", [
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Failed to follow {0}", [
              followedAccount.value?.nymName ?? "PayNym",
            ]),
            context: context,
          ),
        );
    ...
    if (unfollowSuccess && followedAccount.value != null) {
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            type: FlushBarType.success,
            message: goTr(context, "You have unfollowed {0}", [
              followedAccount.value!.nymName,
            ]),
            context: context,
          ),
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            type: FlushBarType.warning,
            message: goTr(context, "Failed to unfollow {0}", [
              followedAccount.value?.nymName ?? "PayNym",
            ]),
            context: context,
          ),
