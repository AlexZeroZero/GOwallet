...
class _TransactionCardState extends ConsumerState<TransactionCard> {
  ...
  String whatIsIt(
    ...
    if (coin is Epiccash && _transaction.slateId == null) {
      return goTr(context, "Restored Funds");
    }
    ...
    if (type != TransactionType.incoming &&
      ...
      // if (type == "Received") {
      if (confirmedStatus) {
        return goTr(context, "Anonymized");
      } else {
        return goTr(context, "Anonymizing");
      }
      // } else if (type == "Sent") {
      //   if (_transaction.confirmedStatus) {
      //     return goTr(context, "Sent MINT");
      //   } else {
      //     return goTr(context, "Sending MINT");
      //   }
      // } else {
      //   return type;
      // }
    ...
    if (type == TransactionType.incoming) {
      ...
      //   return goTr(context, "Minting");
      // } else
      if (confirmedStatus) {
        return goTr(context, "Received");
      } else {
        return goTr(context, "Receiving");
      }
    } else if (type == TransactionType.outgoing) {
      if (confirmedStatus) {
        return goTr(context, "Sent");
      } else {
        return goTr(context, "Sending");
      }
    } else if (type == TransactionType.sentToSelf) {
      return goTr(context, "Sent to self");
    } else {
      return type.name;
    }
  }
