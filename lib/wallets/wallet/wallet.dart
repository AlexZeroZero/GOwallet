...
import 'impl/public_electrum_wallet.dart';
...
abstract class Wallet<T extends CryptoCurrency> {
  ...
  static Wallet _loadWallet({required WalletInfo walletInfo}) {
    if (walletInfo.coin is CustomElectrumCurrency) {
      return PublicElectrumWallet(walletInfo.coin as CustomElectrumCurrency);
    }
