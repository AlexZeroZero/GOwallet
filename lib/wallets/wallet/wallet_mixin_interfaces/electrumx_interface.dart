...
mixin ElectrumXInterface<T extends ElectrumXCurrencyInterface>
  ...
  Future<FeeObject> get fees async {
    try {
      ...
      final maximum = maximumFeerate;
      if (maximum != null && [feeObject.fast, feeObject.medium, feeObject.slow]
          .any((rate) => rate > BigInt.from(maximum))) {
        throw StateError('Node fee estimate exceeds wallet safety limit');
      }
  ...
  /// Coins with standard transaction formats authenticate the returned txid.
  void validateBroadcastResponse(String raw, String txid) {}
  ...
  Future<TxData> confirmSend({required TxData txData}) async {
    try {
      ...
      validateBroadcastResponse(txData.raw!, txHash);
            ...
            if (path.startsWith(
              ...
              receiveFutures.add(
                canBatch
                    ...
                    : checkGapsLinearly(scanRoot, type, receiveChain),
              );
            }
          }
            ...
            if (path.startsWith(
              ...
              changeFutures.add(
                canBatch
                    ...
                    : checkGapsLinearly(scanRoot, type, changeChain),
              );
            }
          }
