  ...
  void initState() {
    ...
    _verify = IfNotAlreadyAsync<void>(() async {
      ...
      final verified = await showLoading(
        ...
        context: context,
        message: goTr(context, "Verifying..."),
        ...
        if (ex != null) {
          ...
          await showDialog<void>(
            ...
            builder: (context) => StackOkDialog(
              title: verified == true
                  ? goTr(context, "Verification succeeded")
                  : goTr(context, "Verification failed"),
    ...
    return ConditionalParent(
      ...
      child: Column(
        ...
        children: [
          ...
          SelectableText(goTr(context, "Message"), style: _getStyle(context)),
          ...
          SelectableText(goTr(context, "Address"), style: _getStyle(context)),
          SizedBox(height: Util.isDesktop ? 10 : 8),
          AdaptiveTextField(
          ...
          SelectableText(goTr(context, "Signature"), style: _getStyle(context)),
          SizedBox(height: Util.isDesktop ? 10 : 8),
          AdaptiveTextField(
