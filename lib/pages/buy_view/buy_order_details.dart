        ...
        children: [
          ...
          RoundedWhiteContainer(
            child: Column(
              ...
              children: [
                Text(
                  goTr(context, "Receiving {0} address", [
                    widget.order.quote.crypto.ticker.toUpperCase(),
                  ]),
                  style: STextStyles.label(context),
                ),
                Text(
          ...
          TextButton(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  goTr(context, "Copy to clipboard"),
