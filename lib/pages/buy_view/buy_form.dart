        ...
        showDialog(
          ...
          builder: (context) => WillPopScope(
            child: CustomLoadingOverlay(
              message: goTr(context, "Loading currency data"),
              eventBus: null,
            ),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            goTr(context, "Choose a crypto to buy"),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(left: 32),
                          child: Text(
                            goTr(context, "Choose a fiat with which to pay"),
                            style: STextStyles.desktopH3(context),
                          ),
                        ),
                        const DesktopDialogCloseButton(),
  ...
  Future<void> previewQuote(SimplexQuote quote) async {
    ...
    unawaited(
      showDialog(
        ...
        builder: (context) => WillPopScope(
          child: CustomLoadingOverlay(
            message: goTr(context, "Loading quote data"),
            eventBus: null,
          ),
          onWillPop: () async => shouldPop,
        ),
        ...
        await showDialog<dynamic>(
          ...
          builder: (context) {
            if (isDesktop) {
              return DesktopDialog(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        goTr(context, "Simplex API unresponsive"),
                        style: STextStyles.desktopH3(context),
                      ),
              ...
              return StackDialog(
                title: goTr(context, "Simplex API error"),
            ...
            return DesktopDialog(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      goTr(context, "Simplex API error"),
                      style: STextStyles.desktopH3(context),
                    ),
                    const SizedBox(height: 24),
                    Text(
        ...
        child: Column(
          ...
          children: [
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Text(
                            selectedCrypto?.ticker ?? goTr(context, "ERR"),
            ...
            Row(
              ...
              children: [
                Text(
                  goTr(context, "I want to pay with"),
                  style: STextStyles.itemSubtitle(context).copyWith(
                    color: Theme.of(
                      context,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text(
                          selectedFiat?.ticker ?? goTr(context, "ERR"),
                          style: STextStyles.largeMedium14(context),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(
                            selectedFiat?.name ?? goTr(context, "Error"),
                            style: STextStyles.largeMedium14(context),
                          ),
                        ),
                        SvgPicture.asset(
            ...
            Row(
              ...
              children: [
                Text(
                  buyWithFiat
                      ? goTr(context, "Enter amount")
                      : goTr(context, "Enter crypto amount"),
                  style: STextStyles.itemSubtitle(context).copyWith(
                    color: Theme.of(
                      context,
                    ).extension<StackColors>()!.textDark3,
                ...
                CustomTextButton(
                  text: buyWithFiat
                      ? goTr(context, "Use crypto amount")
                      : goTr(context, "Use fiat amount"),
                  onTap: () {
                    setState(() {
                      buyWithFiat = !buyWithFiat;
                    });
            ...
            Row(
              ...
              children: [
                Text(
                  goTr(context, "Enter receiving address"),
                  style: STextStyles.itemSubtitle(context).copyWith(
                    color: Theme.of(
                      context,
                    ).extension<StackColors>()!.textDark3,
                ...
                if (AppConfig.isStackCoin(selectedCrypto?.ticker))
                  CustomTextButton(
                    text: goTr(context, "Choose from {0}", [AppConfig.prefix]),
                    onTap: () {
                      try {
            ...
            PrimaryButton(
              ...
              label: goTr(context, "Preview quote"),
            ),
          ],
        ),
      ),
