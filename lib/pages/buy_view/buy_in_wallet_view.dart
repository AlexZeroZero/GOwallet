...
class BuyInWalletView extends StatefulWidget {
  const BuyInWalletView({super.key, required this.coin, this.contract});
    ...
    return Background(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            goTr(context, "Buy {0}", [widget.coin?.ticker]),
            style: STextStyles.navBarTitle(context),
          ),
        ),
        body: BuyView(coin: widget.coin, tokenContract: widget.contract),
      ),
    );
  }
}
