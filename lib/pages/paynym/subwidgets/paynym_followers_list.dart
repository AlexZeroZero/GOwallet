...
class PaynymFollowersList extends ConsumerStatefulWidget {
  const PaynymFollowersList({super.key, required this.walletId});
    ...
    return ConditionalParent(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (BuildContext context, int index) =>
            Container(height: 1.5, color: Colors.transparent),
          ...
          if (count == 0) {
            return RoundedWhiteContainer(
              child: Row(
                ...
                children: [
                  Text(
                    goTr(context, "Your PayNym followers will appear here"),
                    style: isDesktop
