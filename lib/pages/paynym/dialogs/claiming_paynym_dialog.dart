  ...
  Widget build(BuildContext context) {
    if (Util.isDesktop) {
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    goTr(context, "Claiming PayNym"),
                    style: STextStyles.desktopH2(context),
                  ),
                  const SizedBox(height: 20),
                  Text(
                    goTr(context, "We are generating your PayNym"),
      ...
      return WillPopScope(
        ...
        child: StackDialog(
          title: goTr(context, "Claiming PayNym"),
          message: goTr(context, "We are generating your PayNym"),
