  ...
  Future<void> _onConnectPressed() async {
    ...
    try {
      ...
      await showDialog<void>(
        context: context,
        builder: (context) =>
            StackOkDialog(title: goTr(context, "Error"), message: e.toString()),
      );
      return;
    }
                    ...
                    children: [
                      ...
                      RoundedContainer(
                        ...
                        child: Text(
                          goTr(
                            context,
                            "Adding a PayNym to your contacts requires a one-time transaction fee for creating the record on the blockchain. Please deposit more {0} into your wallet and try again.",
