        ...
        await showDialog<dynamic>(
          ...
          builder: (context) {
            return StackOkDialog(
              title: goTr(context, "Purchase failed"),
        ...
        child: Column(
          ...
          children: [
            ...
            if (card.termsAndConditions != null &&
              ...
              SizedBox(height: isDesktop ? 16 : 12),
              _TitledInfoBlock(
                title: goTr(context, "Terms & conditions"),
            ...
            if (card.expiryAndValidity != null &&
              ...
              SizedBox(height: isDesktop ? 16 : 12),
              _TitledInfoBlock(
                title: goTr(context, "Expiry & validity"),
            ...
            SizedBox(height: isDesktop ? 24 : 16),
            Text(
              goTr(context, "Email for receipt and delivery"),
              style: isDesktop
  ...
  Widget build(BuildContext context) {
    ...
    if (card.isRangeDenomination) {
      return Column(
        ...
        children: [
          Text(
            goTr(context, "Enter amount ({0} - {1} {2})", [
              card.minValue?.toStringAsFixed(2) ?? '?',
            ...
            Expanded(
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: goTr(context, "I agree to the ")),
                    TextSpan(
                      text: goTr(context, "terms and conditions"),
                    ...
                    TextSpan(
                      text: goTr(
                        context,
                        ", confirm I am not using a VPN, and understand refunds are voided. I understand that the gift card will be delivered to the listed email.",
                      ),
                    ),
                  ],
                ),
