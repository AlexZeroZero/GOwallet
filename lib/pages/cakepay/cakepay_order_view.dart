  ...
  void _payWithOption(CakePayPaymentOption option, String orderId) {
    ...
    if (option.address.trim().isEmpty) {
      showFloatingFlushBar(
        ...
        message: goTr(context, "No payment address available for {0}", [label]),
        context: context,
      );
      return;
    }
    ...
    if (coin == null) {
      showFloatingFlushBar(
        type: FlushBarType.warning,
        message: goTr(context, "No wallet support for {0}", [label]),
        context: context,
      );
      return;
    }
    ...
    if (!hasWallet) {
      showFloatingFlushBar(
        type: FlushBarType.warning,
        message: goTr(context, "No {0} wallet found. Create one first.", [
          label,
        ]),
        context: context,
      );
      ...
      RoundedWhiteContainer(
        onPressed: () {
          ...
          showFloatingFlushBar(
            ...
            message: goTr(context, "Order ID copied"),
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(goTr(context, "Order ID"), style: subtitleStyle),
      ...
      if (order.createdAt != null) ...[
        ...
        RoundedWhiteContainer(
          child: Row(
            ...
            children: [
              Text(goTr(context, "Created"), style: subtitleStyle),
        ...
        RoundedWhiteContainer(
          child: Row(
            ...
            children: [
              ...
              Text(
                goTr(context, "\${0} USD", [order.amountUsd]),
                style: isDesktop
                    ? STextStyles.desktopTextSmall(context)
                    : STextStyles.titleBold12(context),
              ),
        ...
        details.add(
          RoundedWhiteContainer(
            child: Column(
              ...
              children: [
                Text(
                  item.name ?? goTr(context, "Gift Card"),
                  style: isDesktop
                      ? STextStyles.desktopTextSmall(context)
                      : STextStyles.titleBold12(context),
                ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  Expanded(
                    child: Text(
                      status == CakePayOrderStatus.complete
                          ? goTr(context, "Order complete.")
                          : goTr(context, "Payment received."),
                      style:
                          (isDesktop
                                  ? STextStyles.desktopTextExtraExtraSmall(
                                      context,
              ...
              Text(
                goTr(
                  context,
                  "Your gift card details will be sent to the email address provided when creating the order.",
                ),
                style: isDesktop
                    ? STextStyles.desktopTextExtraExtraSmall(context)
                    : STextStyles.itemSubtitle12(context),
        ...
        RoundedWhiteContainer(
          child: Column(
            ...
            children: [
              ...
              PrimaryButton(
                label: hasWallet
                    ? goTr(context, "Pay with {0}", [label])
                    : goTr(context, "{0} (no wallet)", [label]),
                enabled: hasWallet,
                onPressed: hasWallet
