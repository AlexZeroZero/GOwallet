    ...
    try {
        ...
        if (context.mounted) {
          unawaited(
            showFloatingFlushBar(
              ...
              message: goTr(
                context,
                "Payment sent! Check order status for updates.",
              ),
              context: context,
            ),
          );
      ...
      if (context.mounted) {
        ...
        await showDialog<dynamic>(
          ...
          builder: (context) {
            return StackDialog(
              title: goTr(context, "Broadcast transaction failed"),
              message: e.toString(),
      ...
      unlocked = await Navigator.push(
        ...
        RouteGenerator.getRoute<dynamic>(
          ...
          builder: (_) => LockscreenView(
            ...
            biometricsAuthenticationTitle: goTr(context, "Confirm Transaction"),
          ),
        ...
        return Background(
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                goTr(context, "Confirm transaction"),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text(
                    goTr(context, "Confirm {0} transaction", [coin.ticker]),
        ...
        child: Column(
          ...
          children: [
            ConditionalParent(
              ...
              child: Text(
                goTr(context, "Send {0}", [coin.ticker]),
                style: isDesktop
