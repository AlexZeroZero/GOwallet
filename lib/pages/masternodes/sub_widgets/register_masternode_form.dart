  ...
  void initState() {
    ...
    _register = IfNotAlreadyAsync<void>(() async {
      ...
      final txId = await showLoading(
        ...
        message: goTr(
          context,
          "Creating and submitting masternode registration...",
        ),
        ...
        if (ex != null || txId == null) {
          ...
          await showDialog<void>(
            ...
            builder: (_) => StackOkDialog(
              title: goTr(context, "Registration failed"),
              message: message,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
              ...
              child: RoundedContainer(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        goTr(context, "Masternode collateral"),
        ...
        SelectableText(goTr(context, "IP:Port"), style: _getStyle(context)),
        ...
        SelectableText(
          goTr(context, "Operator public key (BLS)"),
        ...
        SelectableText(
          goTr(context, "Voting address (optional)"),
          style: _getStyle(context),
        ),
        SizedBox(height: Util.isDesktop ? 10 : 8),
        AdaptiveTextField(
          ...
          showPasteClearButton: true,
          maxLines: 1,
          labelText: goTr(context, "Defaults to owner address"),
          onChangedComprehensive: (_) => _validate(),
        ),
        SizedBox(height: Util.isDesktop ? 24 : 16),

        SelectableText(
          goTr(context, "Operator reward (%)"),
          style: _getStyle(context),
        ),
        SizedBox(height: Util.isDesktop ? 10 : 8),
        AdaptiveTextField(
