  ...
  Future<bool> _requestAndProcessCancel() async {
    final shouldCancel = await showDialog<bool?>(
      ...
      builder: (_) => StackDialog(
        title: goTr(context, "Cancel fusion?"),
    ...
    if (shouldCancel == true && mounted) {
      ...
      await showLoading(
        ...
        message: goTr(context, "Stopping fusion"),
      );
