    ...
    try {
      ...
      if (mounted) {
        await showDialog<void>(
          context: context,
          builder: (_) => StackOkDialog(
            title: goTr(context, "Add DNS record failed"),
            desktopPopRootNavigator: Util.isDesktop,
            maxWidth: Util.isDesktop ? 600 : null,
          ),
        );
        ...
        children: [
          ...
          RoundedWhiteContainer(
            child: Row(
              ...
              children: [
                ...
                Text(
                  goTr(context, "{0}.bit", [widget.domainName.substring(2)]),
                  style: Util.isDesktop
          ...
          ConditionalParent(
            ...
            child: CustomTextButton(
              text: _settingsHidden
                  ? goTr(context, "More settings")
                  : goTr(context, "Hide settings"),
              onTap: () {
                setState(() {
            ...
            if (_dnsRecords.isEmpty)
              RoundedWhiteContainer(
                child: Row(
                  ...
                  children: [
                    Text(
                      goTr(context, "Add DNS records to your domain name"),
                ...
                children: [
                  ...
                  SecondaryButton(
                    label: _dnsRecords.isEmpty
                        ? goTr(context, "Add DNS record")
                        : goTr(context, "Add another DNS record"),
