...
class NamecoinNamesHomeView extends ConsumerStatefulWidget {
  const NamecoinNamesHomeView({super.key, required this.walletId});
                ...
                children: [
                  ...
                  Expanded(
                    child: IndexedStack(
                      index: _onManage ? 0 : 1,
                      children: [
                        BuyDomainOptionWidget(walletId: widget.walletId),
                        LayoutBuilder(
