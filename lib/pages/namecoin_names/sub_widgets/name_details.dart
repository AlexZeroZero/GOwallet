    ...
    try {
      ...
      if (opNameData?.op == OpName.nameNew) {
        ref
            ...
            .then((onValue) {
              if (onValue != null) {
                final data = (jsonDecode(onValue) as Map)
                    .cast<String, String>();
        ...
        child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            ...
            return utxo == null
                ? Center(
                    child: Text(
                      goTr(context, "Missing output. Was it used recently?"),
