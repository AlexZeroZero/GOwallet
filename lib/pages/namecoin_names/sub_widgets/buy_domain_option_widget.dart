  ...
  Future<void> _lookup() async {
    ...
    try {
      ...
      final result = await showLoading(
        ...
        context: context,
        message: goTr(context, "Searching..."),
      ...
      if (mounted) {
        await showDialog<void>(
          ...
          builder: (_) => StackOkDialog(
            title: goTr(context, "Name lookup failed"),
            message: err,
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: goTr(context, "Find a domain name"),
          ...
          children: [
            Flexible(
              child: Column(
                ...
                children: [
                  Text(
                    goTr(context, "{0}.bit", [formattedName.substring(2)]),
                    style: style,
                  ),
                  const SizedBox(height: 4),
