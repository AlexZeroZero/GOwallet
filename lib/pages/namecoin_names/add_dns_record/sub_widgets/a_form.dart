...
class _AFormState extends NameFormState<AForm> {
  ...
  DNSRecord buildRecord() {
    ...
    if (_addressType == DNSAddressType.Tor) {
      ...
      map = {_addressType!.key: addresses};
    }

    return DNSRecord(name: widget.name, type: DNSRecordType.A, data: map);
  }
        ...
        ClipRRect(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: goTr(
                context,
                "e.g. 255.255.255.255, 76f4a520a262c269dcba66bc1f560452e30a44e14ce6b37ce20b8.onion",
              ),
