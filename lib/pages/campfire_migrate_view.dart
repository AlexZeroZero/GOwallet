                ...
                Row(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: AppIcon(width: 50, height: 50),
                    ),
                    Expanded(
                      child: Text(
                        goTr(
                          context,
                          "Your old Campfire wallets are listed below. If you would like to keep them then copy the mnemonics somewhere safe so you can restore them.",
                        ),
      ...
      children: [
        ...
        PrimaryButton(
          ...
          onPressed: () {
            ...
            Navigator.of(context).pushNamed(IntroView.routeName);
          },
        ),
      ],
    );
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(widget.name, style: STextStyles.w500_14(context)),
              CustomTextButton(
                text: goTr(context, "Copy mnemonic"),
          ...
          const SizedBox(height: 10),
          _show
              ? MnemonicTable(words: widget.mnemonic, isDesktop: Util.isDesktop)
              : Padding(
                  padding: const EdgeInsets.all(16),
                  child: PrimaryButton(
                    label: goTr(context, "Show mnemonic"),
