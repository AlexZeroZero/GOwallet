...
class _TransactionV2DetailsViewState
      ...
      if (Util.isDesktop) {
        if (_transaction.vSize == null) {
          final updatedTx = await showLoading(
            ...
            context: context,
            message: goTr(context, "Fetching transaction vSize..."),
          );
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          goTr(context, "Boost transaction"),
  ...
  String whatIsIt(TransactionV2 tx, int height) => goTransactionStatus(
    context,
    tx.statusLabel(
      ...
      child: Scaffold(
        ...
        appBar: isDesktop
            ...
            : AppBar(
                ...
                title: Text(
                  goTr(context, "Transaction details"),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (kDebugMode)
                                _DetailItem(
                                  label: goTr(context, "Tx sub type"),
            ...
            ? ConditionalParent(
                ...
                child: SizedBox(
                  ...
                  child: TextButton(
                        ...
                        if (id == null) {
                          unawaited(
                            showFloatingFlushBar(
                              ...
                              message: goTr(
                                context,
                                "Could not find Epic transaction ID",
                              ),
                              context: context,
                            ),
                          );
                        ...
                        if (context.mounted) {
                          ...
                          if (result.isEmpty) {
                            await showDialog<dynamic>(
                              context: context,
                              builder: (_) => StackOkDialog(
                                title: goTr(context, "Transaction cancelled"),
                                onOkPressed: (_) {
                        ...
                        if (id == null) {
                          unawaited(
                            showFloatingFlushBar(
                              ...
                              message: goTr(
                                context,
                                "Could not find MWC transaction ID",
                              ),
                              context: context,
                            ),
                          );
                    ...
                    child: Text(
                      goTr(context, "Cancel Transaction"),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (widget.coin is! Epiccash &&
                          widget.coin is! Mimblewimblecoin)
                        CustomTextButton(
                          text: goTr(context, "Open in block explorer"),
                          onTap: () async {
                            final uri = getBlockExplorerTransactionUrlFor(
                              coin: widget.coin,
                              txid: widget.txid,
