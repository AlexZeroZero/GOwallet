  ...
  Future<void> _previewTxn() async {
    ...
    try {
      ...
      final txData = await showLoading(
        ...
        context: context,
        message: goTr(context, "Preparing RBF Transaction..."),
        onException: (e) => ex = e,
      );
      ...
      if (txData == null && mounted) {
        await showDialog<void>(
          context: context,
          builder: (_) => StackOkDialog(
            title: goTr(context, "RBF send error"),
            message: ex?.toString() ?? goTr(context, "Unknown error found"),
            maxWidth: 600,
          ),
        );
        return;
            ...
            return Column(
              children: [
                ...
                PrimaryButton(
                  ...
                  label: goTr(context, "Preview send"),
            ...
            children: [
              ConditionalParent(
                ...
                child: Column(
                  children: [
                    DetailItem(
                      title: goTr(context, "Send amount"),
                      detail: amountString,
                      horizontal: true,
                    ),
                    const _Divider(),
                    DetailItem(
                      title: goTr(context, "Current fee"),
                      detail: feeString,
                      horizontal: true,
                    ),
                    const _Divider(),
                    DetailItem(
                      title: goTr(context, "Current rate"),
