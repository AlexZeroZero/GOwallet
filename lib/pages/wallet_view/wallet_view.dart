    ...
    if (coin.network.isTestNet) {
      await showDialog<void>(
        ...
        builder: (_) => StackOkDialog(
          title: goTr(context, "Exchange not available for test net coins"),
        ),
      );
    } else {
  ...
  Future<void> _onBuyPressed(BuildContext context) async {
    ...
    if (coin.network.isTestNet) {
      await showDialog<void>(
        context: context,
        builder: (_) => StackOkDialog(
          title: goTr(context, "Buy not available for test net coins"),
        ),
      );
    } else {
      if (mounted) {
      ...
      showDialog(
        ...
        builder: (context) => WillPopScope(
          child: CustomLoadingOverlay(
            message: goTr(context, "Anonymizing balance"),
            eventBus: null,
          ),
      ...
      if (mounted) {
        ...
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "No funds available to privatize!"),
            context: context,
          ),
        );
      }
    ...
    try {
      ...
      if (mounted) {
        ...
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Privatize transaction submitted"),
            context: context,
          ),
        );
      }
      ...
      if (mounted) {
        ...
        await showDialog<dynamic>(
          context: context,
          builder: (_) => StackOkDialog(
            title: goTr(context, "Privatize all failed"),
            message: goTr(context, "Reason: {0}", [e]),
          ),
        );
      }
    }
    ...
    final dockMoreItems = <WalletNavigationBarItemData>[
      ...
      if (wallet is SignVerifyInterface && !viewOnly)
        WalletNavigationBarItemData(
          ...
          label: goTr(context, "Sign/Verify"),
          onTap: () {
            Navigator.of(
              context,
      ...
      if (wallet is CoinControlInterface &&
        ...
        WalletNavigationBarItemData(
          label: goTr(context, "Coin control"),
          icon: const CoinControlNavIcon(),
          onTap: () {
            Navigator.of(context).pushNamed(
      ...
      if (wallet is FiroWallet &&
        ...
        WalletNavigationBarItemData(
          label: goTr(context, "Spark coins"),
          icon: const CoinControlNavIcon(),
          onTap: () {
            Navigator.of(
              context,
