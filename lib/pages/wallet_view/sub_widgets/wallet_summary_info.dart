...
class WalletSummaryInfo extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (coin is Firo || ref.watch(pWalletInfo(walletId)).isMwebEnabled) {
      ...
      toggleBalance = true;
      balanceToShow = _showAvailable ? balance.spendable : balance.total;
      title = _showAvailable ? goTr(context, "可用余额") : goTr(context, "全部余额");
    }
                ...
                onTap: () {
                  ...
                  unawaited(
                    showFloatingFlushBar(
                      ...
                      message: goTr(context, "Address copied to clipboard"),
...
class _HeroChartCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fallback = ref
        .watch(priceAnd24hChangeNotifierProvider)
        .getSparkline(ref.watch(pWalletCoin(walletId)));
                    ...
                    for (final r in _ranges)
                      GestureDetector(
                        ...
                        onTap: () =>
                            ref
                                .read(
                                  _chartRangeDaysProvider(walletId).notifier,
                                )
                                .state = r
                                .days,
                        child: Container(
