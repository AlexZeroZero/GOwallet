import 'dart:async';
import '../../../gowallet/l10n/go_localizations.dart';
...
class _WalletSyncChipState extends ConsumerState<WalletSyncChip> {
  ...
  void initState() {
    ...
    _subscription = GlobalEventBus.instance
  ...
  Widget build(BuildContext context) {
    ...
    final String label = switch (_status) {
      WalletSyncStatus.synced => "钱包已同步",
      WalletSyncStatus.syncing => "同步中",
      WalletSyncStatus.unableToSync => "连接异常",
    };
