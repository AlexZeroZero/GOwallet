...
class _GenerateUriQrCodeViewState extends State<GenerateUriQrCodeView> {
  ...
  String? _generateURI() {
    ...
    if (amountString.isNotEmpty && amount == null) {
      showFloatingFlushBar(
        type: FlushBarType.warning,
        message: goTr(context, "Invalid amount"),
        context: context,
      );
      return null;
    }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            PrimaryButton(
              label: goTr(context, "Generate QR code"),
              onPressed: isDesktop
                  ? () {
                      final uriString = _generateURI();
                      if (uriString == null) {
