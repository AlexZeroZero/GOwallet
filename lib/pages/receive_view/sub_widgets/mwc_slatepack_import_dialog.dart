...
class _MwcSlatepackImportDialogState
  ...
  Future<void> _processPressed() async {
    ...
    final result = await showLoading(
      ...
      context: context,
      message: goTr(context, "Processing slatepack..."),
      onException: (e) => ex = e,
    );
      ...
      if (mounted) {
        await showDialog<void>(
          ...
          builder: (context) => StackOkDialog(
            ...
            title: goTr(context, "Slatepack receive error"),
            message:
                ex?.toString() ??
                goTr(context, "Unexpected result without exception"),
          ),
        );
      }
      return;
          ...
          if (Util.isDesktop)
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    goTr(context, "Response Slatepack"),
                    style: STextStyles.pageTitleH2(context),
                  ),
                  const DesktopDialogCloseButton(),
                ],
