                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            CustomTextButton(
                              text: goTr(context, "View QR code"),
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              goTr(context, "Transaction history"),
                              style:
                                  STextStyles.desktopTextExtraExtraSmall(
                                    context,
                                  ).copyWith(
            ...
            child: Column(
              ...
              children: [
                ...
                if (address.derivationPath != null)
                  DetailItem(
                    title: goTr(context, "Derivation path"),
                ...
                if (address.type == AddressType.spark)
                  DetailItem(
                    title: goTr(context, "Diversifier"),
                ...
                if (address.type == AddressType.mweb)
                  DetailItem(
                    title: goTr(context, "Index"),
                    detail: address.derivationIndex.toString(),
                    button: Container(),
                  ),
                const _Div(height: 12),
                DetailItem(
                  title: goTr(context, "Type"),
                  detail: address.type.readableName,
                  button: Container(),
                ),
                const _Div(height: 12),
                DetailItem(
                  title: goTr(context, "Sub type"),
                ...
                if (kDebugMode)
                  DetailItem(
                    title: goTr(context, "frost secure (kDebugMode)"),
      ...
      child: Column(
        ...
        children: [
          ...
          tags != null && tags!.isNotEmpty
              ...
              : Text(
                  goTr(context, "Tags will appear here"),
