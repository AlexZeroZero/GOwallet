  ...
  Future<void> _importSlatepack() async {
    ...
    if (mounted) {
      ...
      final result = await showLoading(
        ...
        context: context,
        message: goTr(context, "Decoding slatepack..."),
        onException: (e) => ex = e,
      );
  ...
  Future<void> _importEpicSlatepack() async {
    ...
    if (mounted) {
      ...
      final result = await showLoading(
        whileFuture: wallet.fullDecodeSlatepack(slatepackString),
        context: context,
        message: goTr(context, "Decoding slate..."),
        onException: (e) => ex = e,
      );
            ...
            return WillPopScope(
              ...
              child: Container(
                ...
                child: CustomLoadingOverlay(
                  message: goTr(context, "Generating address"),
                  eventBus: null,
                ),
              ),
            );
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    GoNotice(
                      title: goTr(context, "只接收当前币种"),
                      detail: goTr(context, "向此地址发送其他网络的资产可能无法找回。首次收款请先做小额测试。"),
                                    ...
                                    child: Text(
                                      _supportsSpark &&
                                              _walletAddressTypes[i] ==
                                                  AddressType.p2pkh
                                          ? goTr(context, "Transparent address")
                    ...
                    if (coin is Mimblewimblecoin) ...[
                      const SizedBox(height: 12),
                      SecondaryButton(
                        label: goTr(context, "Import Slatepack"),
                    ...
                    if (coin is Epiccash) ...[
                      const SizedBox(height: 12),
                      SecondaryButton(
                        label: goTr(context, "Import Slate"),
