    ...
    return Background(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            tokenWallet != null
                ? goTr(context, "Receive {0}", [tokenWallet.tokenSymbol])
                : goTr(context, "Receive Token"),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    goTr(context, "Your Solana address"),
                                ...
                                onTap: () async {
                                  ...
                                  if (mounted) {
                                    showFloatingFlushBar(
                                      ...
                                      message: goTr(context, "Address copied"),
                                      context: context,
                                    );
                                  }
                                },
