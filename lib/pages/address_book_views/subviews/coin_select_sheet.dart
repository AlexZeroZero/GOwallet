...
class CoinSelectSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    coins_.removeWhere((e) => e is Firo && e.network.isTestNet);
    return Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                goTr(context, "Select address cryptocurrency"),
                    ...
                    return ListView.builder(
                      ...
                      itemCount: showTestNet
                          ...
                          : coins_
                                .where(
                                  (e) =>
                                      e.network != CryptoCurrencyNetwork.test,
                                )
                                .length,
                          ...
                          child: RawMaterialButton(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  SvgPicture.file(
                                    File(ref.watch(coinImageProvider(coin))),
                                    height: 20,
                                    width: 20,
                                  ),
