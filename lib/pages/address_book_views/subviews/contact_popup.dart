...
final exchangeFromAddressBookAddressStateProvider = StateProvider<String>(
  (ref) => "",
);
...
class ContactPopUp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bool isExchangeFlow = ref
        .watch(exchangeFlowIsActiveStateProvider.state)
        .state;

    final addresses = contact.addressesSorted
        .where((e) {
                                  ...
                                  child: RoundedWhiteContainer(
                                    child: Center(
                                      child: Text(
                                        goTr(
                                          context,
                                          "No {0} addresses found",
                                          [
                                            ref
                                                .watch(pWalletCoin(active!))
                                                .prettyName,
                                          ],
                                        ),
