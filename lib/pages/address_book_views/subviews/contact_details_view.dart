                  ...
                  onPressed: () {
                    showDialog<dynamic>(
                      ...
                      builder: (_) => StackDialog(
                        title: goTr(context, "Delete {0}?", [_contact.name]),
                        message: goTr(
                          context,
                        ...
                        rightButton: TextButton(
                          ...
                          onPressed: () {
                            ...
                            showFloatingFlushBar(
                              ...
                              message: goTr(context, "{0} deleted", [
                                _contact.name,
                              ]),
                              context: context,
                            );
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Container(
                          ...
                          child: Center(
                            child: _contact.emojiChar == null
                                ? adaptiveSvg(Assets.svg.user, size: 24)
                                : Text(
                                    _contact.emojiChar!,
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          goTr(context, "Addresses"),
                          style: STextStyles.itemSubtitle(context),
                        ),
                        CustomTextButton(
                          text: goTr(context, "Add new"),
                          onTap: () {
                            Navigator.of(context).pushNamed(
                            ...
                            if (snapshot.connectionState ==
                              ...
                              if (_cachedTransactions.isNotEmpty) {
                                ...
                                return RoundedWhiteContainer(
                                  child: Center(
                                    child: Text(
                                      goTr(context, "No transactions found"),
                                      style: STextStyles.itemSubtitle(context),
                                    ),
                                  ),
                                );
