        ...
        children: [
          ...
          if (contacts.isEmpty)
            RoundedWhiteContainer(
              child: Center(
                child: Text(
                  goTr(context, "Your favorite contacts will appear here"),
          ...
          if (contacts.isEmpty)
            RoundedWhiteContainer(
              child: Center(
                child: Text(
                  goTr(context, "Your contacts will appear here"),
                  style: STextStyles.itemSubtitle(context),
                ),
              ),
            ),
