  ...
  Future<void> _finalizePressed() async {
    ...
    if (mounted) {
      ...
      await showLoading(
        ...
        context: context,
        message: goTr(context, "Finalizing slatepack..."),
        ...
        if (ex != null) {
          await showDialog<void>(
            ...
            builder: (context) => StackOkDialog(
              ...
              title: goTr(context, "Slatepack finalize error"),
              message:
                  ex?.toString() ??
    ...
    return ConditionalParent(
      ...
      builder: (child) => Background(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              goTr(context, "Finalize slatepack"),
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            decoration:
                standardInputDecoration(
                  goTr(context, "Enter Final Slatepack Message"),
                  _slateFocusNode,
                  context,
                  desktopMed: true,
                ).copyWith(
          ...
          PrimaryButton(
            label: goTr(context, "Finalize Slatepack"),
