              ...
              builder: (dialogContext) => ConditionalParent(
                ...
                child: ConditionalParent(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        goTr(context, "Token Already Added"),
                        style: STextStyles.pageTitleH2(context),
                      ),
                      const SizedBox(height: 8),
                      Text(
                        goTr(context, "This token is already in your wallet."),
            ...
            builder: (dialogContext) => ConditionalParent(
              ...
              child: ConditionalParent(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      goTr(context, "Invalid Mint Address"),
                      style: STextStyles.pageTitleH2(context),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      goTr(
                        context,
                        "Please enter a valid Solana token mint address (base58 encoded, ~44 characters).",
                      ),
                      style: STextStyles.smallMed14(context),
                    ),
                    const SizedBox(height: 20),
            ...
            builder: (dialogContext) => ConditionalParent(
              ...
              child: ConditionalParent(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      goTr(context, "Metadata Not Found"),
                      style: STextStyles.pageTitleH2(context),
                    ),
                    const SizedBox(height: 8),
                    Text(
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    goTr(context, "Add custom SOL token"),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: goTr(context, "SOL token mint address"),
                hintStyle: STextStyles.fieldLabel(context),
              ),
            ),
            SizedBox(height: isDesktop ? 16 : 8),
            PrimaryButton(
              label: goTr(context, "Search"),
            ...
            TextField(
              ...
              style: STextStyles.field(context),
              decoration: InputDecoration(
                hintText: goTr(context, "Token name"),
                hintStyle: STextStyles.fieldLabel(context),
              ),
            ),
            SizedBox(height: isDesktop ? 16 : 8),
                ...
                children: [
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: goTr(context, "Decimals"),
                        hintStyle: STextStyles.fieldLabel(context),
                      ),
                    ),
                  ),
