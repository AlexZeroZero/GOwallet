    ...
    if (isMatch) {
      ...
      if (mounted &&
        ...
        try {
          ...
          await showLoading(
            ...
            context: context,
            message: goTr(context, "Converting to view only wallet"),
      ...
      if (mounted) {
        ...
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Correct! Your wallet is set up."),
      ...
      unawaited(
        showFloatingFlushBar(
          ...
          message: goTr(context, "Incorrect. Please try again."),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  goTr(context, "Verify recovery phrase"),
                ...
                Text(
                  isDesktop
                      ? goTr(context, "Select word number")
                      : goTr(context, "Tap word number "),
                  textAlign: TextAlign.center,
                  style: isDesktop
