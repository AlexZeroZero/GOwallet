  ...
  void _verify() {
    ...
    if (passwordController.text ==
      ...
      showFloatingFlushBar(
        ...
        message: goTr(context, "Passphrase does not match"),
        context: context,
      );
    }
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    goTr(context, "Verify mnemonic passphrase"),
      ...
      child: ConditionalParent(
        ...
        child: Column(
          ...
          children: [
            if (!Util.isDesktop)
              Text(
                goTr(context, "Verify BIP39 passphrase"),
            ...
            TextField(
              ...
              decoration:
                  standardInputDecoration(
                    goTr(context, "Enter your BIP39 passphrase"),
                    passwordFocusNode,
                    context,
                  ).copyWith(
                    suffixIcon: UnconstrainedBox(
                      child: ConditionalParent(
                        condition: Util.isDesktop,
                        builder: (child) => SizedBox(height: 70, child: child),
                        child: Row(
                          children: [
