        ...
        child: ConditionalParent(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                goTr(context, "Select Ethereum wallet"),
              ...
              Text(
                goTr(context, "You are adding an ETH token."),
                textAlign: TextAlign.center,
                style: isDesktop
              ...
              Text(
                goTr(
                  context,
                  "You must choose an Ethereum wallet in order to use {0}",
                  [widget.entity.name],
                ),
                textAlign: TextAlign.center,
                style: isDesktop
                  ...
                  ? RoundedWhiteContainer(
                      ...
                      child: Text(
                        _hasEthWallets
                            ? goTr(
                                context,
                                "All current Ethereum wallets already have {0}",
                                [widget.entity.name],
                              )
                            : goTr(
                                context,
              ...
              ethWalletIds.isEmpty
                  ? PrimaryButton(
                      label: goTr(context, "Add new Ethereum wallet"),
