        ...
        child: ConditionalParent(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                goTr(context, "Select Solana wallet"),
              ...
              Text(
                goTr(context, "You are adding a Solana token."),
                textAlign: TextAlign.center,
                style: isDesktop
              ...
              Text(
                goTr(
                  context,
                  "You must choose a Solana wallet in order to use {0}",
                  [widget.entity.name],
                ),
                textAlign: TextAlign.center,
                style: isDesktop
                  ...
                  ? RoundedWhiteContainer(
                      ...
                      child: Text(
                        _hasSolWallets
                            ? goTr(
                                context,
                                "All current Solana wallets already have {0}",
                                [widget.entity.name],
                              )
                            : goTr(
                                context,
              ...
              solWalletIds.isEmpty
                  ? PrimaryButton(
                      label: goTr(context, "Add new Solana wallet"),
