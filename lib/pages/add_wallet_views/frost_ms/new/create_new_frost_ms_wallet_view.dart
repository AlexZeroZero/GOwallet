    ...
    showDialog<void>(
      ...
      builder: (_) => SimpleMobileDialog(
        child: Column(
          ...
          children: [
            Text(
              goTr(context, "What is a threshold?"),
            ...
            Text(
              goTr(
                context,
                "A threshold is the amount of people required to perform an action. This does not have to be the same number as the total number in the group.",
              ),
            ...
            Text(
              goTr(
                context,
                "For example, if you have 3 people in the group, but a threshold of 2, then you only need 2 out of the 3 people to sign for an action to take place.",
              ),
              style: STextStyles.w400_16(context),
            ),
            const SizedBox(height: 6),
            Text(
              goTr(
                context,
                "Conversely if you have a group of 3 AND a threshold of 3, you will need all 3 people in the group to sign to approve any action.",
              ),
              style: STextStyles.w400_16(context),
            ),
          ],
      ...
      builder: (child) => DesktopScaffold(
        ...
        appBar: DesktopAppBar(
          ...
          trailing: FrostMascot(
            title: goTr(context, "Lorem ipsum"),
            body:
          ...
          children: [
            Row(
              ...
              children: [
                ...
                CustomTextButton(
                  text: goTr(context, "What is a threshold?"),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: goTr(context, "Enter number of signatures"),
                hintStyle: STextStyles.fieldLabel(context),
              ),
            ),
            const SizedBox(height: 16),
            Text(
              goTr(context, "Number of participants"),
              style: STextStyles.w500_14(context).copyWith(
            ...
            Column(
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: goTr(context, "Enter number of participants"),
                    hintStyle: STextStyles.fieldLabel(context),
                  ),
                ),
                const SizedBox(height: 6),
              ...
              Column(
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: goTr(context, "Enter your name"),
                      hintStyle: STextStyles.fieldLabel(context),
                    ),
                  ),
                  const SizedBox(height: 6),
            ...
            if (controllers.length > 1)
              Column(
                ...
                children: [
                  Text(
                    goTr(context, "Remaining participants"),
                    style: STextStyles.w500_14(context).copyWith(
                      color: Theme.of(
                        context,
                      ).extension<StackColors>()!.textDark3,
                  ...
                  for (int i = 1; i < controllers.length; i++)
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: goTr(context, "Enter name"),
                          hintStyle: STextStyles.fieldLabel(context),
                        ),
                      ),
                    ),
            ...
            const SizedBox(height: 16),
            PrimaryButton(
              label: goTr(context, "Create new group"),
              onPressed: () async {
