      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            goTr(
              context,
              "You should select 'Join a new group' if you are creating a brand new wallet with other people.",
            ),
            style: STextStyles.w600_16(context),
          ),
          const SizedBox(height: 12),
          Text(
            goTr(
              context,
              "You should select 'Join an existing group' if you an existing group is being edited and you are being added as a participant.",
            ),
            style: STextStyles.w600_16(context),
          ),
        ],
