      ...
      child: Column(
        children: [
          ...
          FrostStepField(
            ...
            label: goTr(context, "Enter config"),
            hint: "Enter config",
            onChanged: (_) {
              setState(() {
              ...
              Expanded(
                child: RoundedWhiteContainer(
                  child: Text(
                    goTr(
                      context,
                      "Enter your name EXACTLY as the group creator entered it. The names are case-sensitive.",
                    ),
          ...
          const SizedBox(height: 16),
          PrimaryButton(
            label: goTr(context, "Start key generation"),
              ...
              if (!frostInterface.validateEncodedMultisigConfig(
                ...
                return await showDialog<void>(
                  ...
                  builder: (_) => StackOkDialog(
                    title: goTr(context, "Invalid config"),
