    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          CheckboxTextButton(
            label: goTr(context, "I have verified that everyone has my share"),
            onChanged: (value) {
              setState(() {
              ...
              if (controllers
                ...
                return await showDialog<void>(
                  ...
                  builder: (_) => StackOkDialog(
                    title: goTr(context, "Missing shares"),
                ...
                if (context.mounted) {
                  return await showDialog<void>(
                    ...
                    builder: (_) => FrostErrorDialog(
                      title: goTr(context, "Failed to complete key generation"),
                    ),
                  );
                }
              }
