  ...
  Future<void> _restore() async {
    ...
    try {
      ...
      final wallet = await showLoading(
        ...
        context: context,
        message: goTr(context, "Restoring wallet..."),
      ...
      if (mounted) {
        ...
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Your wallet is set up."),
      ...
      if (mounted) {
        await showDialog<void>(
          ...
          builder: (_) => StackOkDialog(
            title: goTr(context, "Failed to restore"),
            message: e.toString(),
        ...
        builder: (child) => Background(
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                goTr(context, "Restore FROST multisig wallet"),
                                ...
                                : TextFieldIconButton(
                                    ...
                                    onTap: () async {
                                      ...
                                      if (data?.text != null &&
                                        ...
                                        configFieldController.text = data.text!
                                            .trim();
                                      }
