    ...
    try {
      ...
      if (mounted) {
        await showLoading(
          ...
          context: context,
          message: isNew
              ? goTr(context, "Creating wallet")
              : goTr(context, "Updating wallet data"),
          rootNavigator: true,
          onException: (e) => ex = e,
        );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            goTr(context, "Back up your keys and config"),
            style: STextStyles.pageTitleH2(context),
          ),
          const SizedBox(height: 12),
          DetailItem(
            title: goTr(context, "Config"),
            detail: config,
            button: Util.isDesktop
          ...
          const SizedBox(height: 12),
          PrimaryButton(label: goTr(context, "Confirm"), onPressed: _onPressed),
        ],
      ),
    );
  }
