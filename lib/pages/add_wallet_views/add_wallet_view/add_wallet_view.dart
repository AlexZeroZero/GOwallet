...
import '../../../gowallet/go_custom_coin_page.dart';
/* 
...
class _AddWalletViewState extends ConsumerState<AddWalletView> {
  ...
  Future<void> _addCustomCoin() async {
    final coin = await Navigator.of(context).push<CustomElectrumCurrency>(
      MaterialPageRoute(builder: (_) => const GoCustomCoinPage()));
    if (coin != null && mounted) setState(() {
      coinEntities.add(CoinEntity(coin));
      _searchTerm = ''; _searchFieldController.clear();
    });
  }
                          ...
                          child: Column(
                            children: [
                              ...
                              if (tokenEntities.isNotEmpty)
                                ExpandingSubListItem(
                                  title: goTr(context, "Ethereum tokens"),
                              ...
                              if (solTokenEntities.isNotEmpty)
                                ExpandingSubListItem(
                                  title: goTr(context, "Solana tokens"),
                                  entities: filter(
                                    _searchTerm,
                                    solTokenEntities,
                                  ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(alignment: Alignment.centerRight, child: TextButton.icon(
                      key: const Key('addCustomCoin'), onPressed: _addCustomCoin,
                      icon: const Icon(Icons.add_circle_outline), label: Text(goTr(context, '自定义币种')))),
                    const SizedBox(height: 16),
                    ClipRRect(
