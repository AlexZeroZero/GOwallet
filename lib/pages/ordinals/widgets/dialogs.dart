...
class SendOrdinalUnfreezeDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(
                    goTr(context, "This ordinal is frozen"),
    ...
    return StackDialog(
      title: goTr(context, "This ordinal is frozen"),
...
class UnfreezeOrdinalDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StackDialog(
      title: goTr(context, "Are you sure you want to unfreeze this ordinal?"),
      icon: SvgPicture.asset(
        Assets.svg.coinControl.blocked,
        width: 24,
        height: 24,
  ...
  Widget _buildTextField(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: goTr(context, "Paste address"),
      ...
      return DesktopDialog(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(
                goTr(context, "Send ordinal #{0}", [widget.inscriptionNumber]),
                style: STextStyles.desktopH3(context),
              ),
              const SizedBox(height: 12),
              Text(
                goTr(context, "Enter the recipient address"),
                style: STextStyles.desktopTextMedium(context),
              ),
