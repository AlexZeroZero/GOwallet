                            ...
                            TextField(
                              ...
                              decoration:
                                  standardInputDecoration(
                                    goTr(context, "Number of churns"),
                                    churningRoundFocusNode,
                                    context,
                                  ).copyWith(
                                    labelText: goTr(
                                      context,
                                      "Enter number of churns..",
                                    ),
                                  ),
                            ),
                          const SizedBox(height: 16),
                          CheckboxTextButton(
                            label: goTr(context, "Pause on errors"),
                            initialValue: !ref
