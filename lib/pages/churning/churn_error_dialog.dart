...
class ChurnErrorDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ConditionalParent(
      ...
      builder: (child) =>
          DesktopDialog(maxHeight: double.infinity, child: child),
        ...
        child: Column(
          children: [
            Util.isDesktop
                ...
                : Text(errorTitle, style: STextStyles.pageTitleH2(context)),
                ...
                children: [
                  Flexible(
                    child: SelectableText(
                      error.startsWith(goTr(context, "Exception:"))
            ...
            Padding(
              padding: Util.isDesktop
                  ...
                  : const EdgeInsets.all(20),
              child: Text(
                goTr(context, "Stop churning or try and continue?"),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: Util.isDesktop ? 20 : 16),
                  Expanded(
                    child: PrimaryButton(
