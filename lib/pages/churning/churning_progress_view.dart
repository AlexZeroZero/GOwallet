  ...
  Future<bool> _requestAndProcessCancel() async {
    final shouldCancel = await showDialog<bool?>(
      ...
      builder: (_) => StackDialog(
        title: goTr(context, "Cancel churning?"),
        leftButton: SecondaryButton(
          label: goTr(context, "No"),
          buttonHeight: null,
          onPressed: () {
      ...
      child: Background(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              goTr(context, "Churning progress"),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_succeeded)
                              PrimaryButton(
                                label: goTr(context, "Churn again"),
                                onPressed: ref
