  ...
  Future<void> _finalizePressed() async {
    ...
    if (mounted) {
      ...
      await showLoading(
        ...
        context: context,
        message: goTr(context, "Finalizing slate..."),
        ...
        if (ex != null) {
          await showDialog<void>(
            ...
            builder: (context) => StackOkDialog(
              ...
              title: goTr(context, "Slate finalize error"),
              message:
                  ex?.toString() ??
    ...
    return ConditionalParent(
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            decoration:
                standardInputDecoration(
                  goTr(context, "Enter Response Slate JSON"),
                  _slateFocusNode,
                  context,
                  desktopMed: true,
                ).copyWith(
          ...
          PrimaryButton(
            label: goTr(context, "Finalize Slate"),
