...
class _LoggingSettingsViewState extends ConsumerState<LoggingSettingsView> {
  ...
  Future<void> _exportHelper() async {
    ...
    await Share.shareXFiles([
      XFile(zipFile.path),
    ], text: goTr(context, "{0} logs", [AppConfig.appName]));
  }
  ...
  Future<void> _androidExportLogs() async {
    ...
    try {
      await showLoading(
        ...
        context: context,
        message: goTr(context, "Exporting logs..."),
        ...
        unawaited(
          showDialog(
            ...
            builder: (context) => StackOkDialog(
              title: goTr(context, "Failed to export logs"),
              message: e.toString(),
            ),
          ),
        );
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Text(
                      goTr(context, "Log files location"),
