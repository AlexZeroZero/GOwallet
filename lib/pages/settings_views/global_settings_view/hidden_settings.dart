                          ...
                          Consumer(
                            builder: (_, ref, __) {
                              return GestureDetector(
                                ...
                                child: RoundedWhiteContainer(
                                  child: Text(
                                    goTr(context, "Delete notifications"),
                                    style: STextStyles.button(context).copyWith(
                                      color: Theme.of(context)
                                          .extension<StackColors>()!
                                          .accentColorDark,
                          ...
                          Consumer(
                            builder: (_, ref, __) {
                              return GestureDetector(
                                ...
                                child: RoundedWhiteContainer(
                                  child: Text(
                                    goTr(context, "Reset log location"),
                                    style: STextStyles.button(context).copyWith(
                                      color: Theme.of(context)
                                          .extension<StackColors>()!
                                          .accentColorDark,
                          ...
                          Consumer(
                            builder: (_, ref, __) {
                              return GestureDetector(
                                ...
                                child: RoundedWhiteContainer(
                                  child: Text(
                                    goTr(context, "Show Tor warning popup"),
                                    style: STextStyles.button(context).copyWith(
                                      color: Theme.of(context)
                                          .extension<StackColors>()!
                                          .accentColorDark,
