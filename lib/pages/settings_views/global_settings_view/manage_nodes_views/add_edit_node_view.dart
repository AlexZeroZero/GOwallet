    ...
    if (!canConnect && mounted) {
      await showDialog<dynamic>(
        ...
        builder: (_) => isDesktop
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            goTr(context, "Server currently unreachable"),
            ...
            : StackDialog(
                title: goTr(context, "Server currently unreachable"),
                message: goTr(
                  context,
                  "Would you like to save this node anyways?",
                ),
          ...
          appBar: AppBar(
            ...
            title: Text(
              viewType == AddEditNodeViewType.edit
                  ? goTr(context, "Edit node")
                  : goTr(context, "Add node"),
      ...
      children: [
        ...
        if (enableAuthFields)
          TextField(
            ...
            decoration:
                standardInputDecoration(
                  goTr(context, "Password (optional)"),
                  _passwordFocusNode,
                  context,
                ).copyWith(
                  suffixIcon:
        ...
        if (widget.coin is Mimblewimblecoin)
          TextField(
            ...
            decoration:
                standardInputDecoration(
                  goTr(context, "API secret (optional)"),
                  _apiSecretFocusNode,
                  context,
                ).copyWith(
                  suffixIcon:
                      !shouldBeReadOnly && _apiSecretController.text.isNotEmpty
                      ? Padding(
                          padding: const EdgeInsets.only(right: 0),
                          child: UnconstrainedBox(
                            child: Row(
        ...
        if (widget.coin is! Ethereum)
          Row(
            children: [
              RadioTextButton(
                label: goTr(context, "Only TOR traffic"),
        ...
        if (widget.coin is! Ethereum)
          Row(
            children: [
              RadioTextButton(
                label: goTr(context, "Only non-TOR traffic"),
                enabled: !widget.readOnly,
