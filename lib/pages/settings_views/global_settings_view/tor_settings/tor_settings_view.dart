              ...
              child: AppBarIconButton(
                ...
                onPressed: () {
                  showDialog<dynamic>(
                    ...
                    builder: (context) {
                      return StackDialog(
                        title: goTr(context, "What is Tor?"),
                        message: goTr(
                          context,
                          "Short for \"The Onion Router\", is an open-source software that enables internet communication to remain anonymous by routing internet traffic through a series of layered nodes, to obscure the origin and destination of data.",
                        ),
                                      ...
                                      showDialog<dynamic>(
                                        ...
                                        builder: (context) {
                                          return StackDialog(
                                            ...
                                            message: goTr(
                                              context,
                                              "A security feature that protects your information from accidental exposure by disconnecting your device from the Tor network if the connection is disrupted or compromised.",
                                            ),
                                            rightButton: SecondaryButton(
                                              label: goTr(context, "Close"),
          ...
          children: [
            SizedBox(
              ...
              child: Icon(
                Icons.hub_outlined,
                size: 96,
                color: _status == TorConnectionStatus.connected
