    ...
    final result = await showDialog<bool>(
      ...
      builder: (context) => StackDialogBase(
        child: Column(
          ...
          children: [
            Text(
              goTr(context, "Enable duress PIN"),
      ...
      await Navigator.push(
        ...
        RouteGenerator.getRoute(
          ...
          builder: (_) => LockscreenView(
            ...
            biometricsAuthenticationTitle: goTr(context, "Create duress PIN"),
          ),
    ...
    await showDialog<void>(
      ...
      builder: (context) => StackDialogBase(
        child: Column(
          ...
          children: [
            Text(
              goTr(context, "Disable duress PIN"),
              style: STextStyles.pageTitleH2(context),
            ),
            const SizedBox(height: 8),
            Row(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                      ...
                      return RawMaterialButton(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                goTr(context, "Cover in background"),
                                style: STextStyles.titleBold12(context),
                                textAlign: TextAlign.left,
                              ),
                              SizedBox(
                ...
                if (Platform.isAndroid && AppConfig.appName != "GOwallet")
                  const SizedBox(height: 8),
                if (Platform.isAndroid && AppConfig.appName != "GOwallet")
                  RoundedWhiteContainer(
                    child: Consumer(
                        ...
                        return RawMaterialButton(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  goTr(context, "Disable screenshots"),
                                  style: STextStyles.titleBold12(context),
                                  textAlign: TextAlign.left,
                                ),
                                SizedBox(
                        ...
                        return RawMaterialButton(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  goTr(context, "Biometrics opens duress"),
                                  style: STextStyles.titleBold12(context),
                                  textAlign: TextAlign.left,
                                ),
                                SizedBox(
