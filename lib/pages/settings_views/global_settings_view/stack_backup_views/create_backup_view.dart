  ...
  Future<void> _createBackup() async {
    ...
    if (mounted) {
      ...
      final savedPath = await showLoading(
        ...
        context: context,
        message: goTr(context, "Encrypting backup"),
        ...
        if (savedPath != null) {
          await showDialog<dynamic>(
            ...
            builder: (_) => !Util.isDesktop
                ? StackOkDialog(
                    title: goTr(context, "Backup saved to:"),
                    message: savedPath,
                  )
                : DesktopDialog(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            goTr(context, "{0} backup saved to: \n", [
                              AppConfig.prefix,
                            ]),
          ...
          await showDialog<dynamic>(
            ...
            builder: (_) => StackOkDialog(
              title: goTr(context, "Backup creation failed"),
              message: ex?.toString() ?? goTr(context, "Unexpected error"),
            ),
          );
        }
      }
          ...
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  goTr(context, "Choose file location"),
          ...
          children: [
            ...
            if (isDesktop)
              Padding(
                ...
                child: Text(
                  goTr(context, "Create a passphrase"),
                  style: STextStyles.desktopTextExtraExtraSmall(context)
                      .copyWith(
                        color: Theme.of(
                          context,
            ...
            TextField(
              ...
              decoration:
                  standardInputDecoration(
                    goTr(context, "Create passphrase"),
                    passwordFocusNode,
                    context,
                  ).copyWith(
            ...
            TextField(
              ...
              decoration:
                  standardInputDecoration(
                    goTr(context, "Confirm passphrase"),
                      ...
                      Consumer(
                        builder: (context, ref, __) {
                          return PrimaryButton(
                            ...
                            label: goTr(context, "Create backup"),
