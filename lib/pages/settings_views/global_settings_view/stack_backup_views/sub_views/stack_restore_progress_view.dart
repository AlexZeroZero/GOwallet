          ...
          child: Column(
            ...
            children: [
              Material(
                ...
                child: Center(
                  child: Text(
                    goTr(context, "Cancelling restore. Please wait."),
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                goTr(context, "Restoring {0}", [AppConfig.appName]),
                ...
                builder: (_, ref, __) {
                  ...
                  return !isDesktop
                      ? RestoringItemCard(
                          ...
                          title: goTr(context, "Preferences"),
                          subTitle: state == StackRestoringStatus.failed
                              ? Text(
                                  goTr(context, "Something went wrong"),
                ...
                builder: (_, ref, __) {
                  ...
                  return !isDesktop
                      ? RestoringItemCard(
                          ...
                          title: goTr(context, "Exchange history"),
                          subTitle: state == StackRestoringStatus.failed
                              ? Text(
                                  goTr(context, "Something went wrong"),
                                  style: STextStyles.errorSmall(context),
