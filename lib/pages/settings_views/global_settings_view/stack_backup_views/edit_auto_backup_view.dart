  ...
  void onSavePressed() async {
    ...
    if (mounted) {
      ...
      final savedPath = await showLoading(
        ...
        context: context,
        message: goTr(context, "Updating Auto Backup"),
        ...
        if (savedPath != null) {
          ...
          await showDialog<dynamic>(
            ...
            builder: (_) => StackOkDialog(
              title: goTr(context, "{0} Auto Backup saved to:", [
                AppConfig.prefix,
              ]),
              message: savedPath,
            ),
          ...
          await showDialog<dynamic>(
            ...
            barrierDismissible: false,
            builder: (_) => StackOkDialog(
              title: goTr(context, "Failed to update Auto Backup"),
              message: ex?.toString(),
            ),
          );
        }
    ...
    return ConditionalParent(
      ...
      child: Column(
        ...
        children: [
          if (!isDesktop)
            Text(
              goTr(context, "Create your backup"),
