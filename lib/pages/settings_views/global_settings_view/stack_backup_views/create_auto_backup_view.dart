  ...
  Future<void> _createEnableAutoBackup() async {
    ...
    if (mounted) {
      ...
      final savedPath = await showLoading(
        ...
        context: context,
        message: goTr(context, "Encrypting initial backup"),
        ...
        if (savedPath != null) {
          ...
          await showDialog<dynamic>(
            ...
            builder: (_) => StackOkDialog(
              title: goTr(context, "{0} Auto Backup enabled and saved to:", [
                AppConfig.prefix,
              ]),
              message: savedPath,
            ),
          ...
          await showDialog<dynamic>(
            ...
            barrierDismissible: false,
            builder: (_) => StackOkDialog(
              title: goTr(context, "Failed to enable Auto Backup"),
              message: ex?.toString(),
            ),
          );
        }
    ...
    return Background(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            goTr(context, "Create Auto Backup"),
                  ...
                  child: ConstrainedBox(
                    ...
                    child: IntrinsicHeight(
                      child: Column(
                        ...
                        children: [
                          Text(
                            goTr(context, "Create your backup file"),
                          ...
                          TextButton(
                            ...
                            child: Text(
                              goTr(context, "Enable Auto Backup"),
