      ...
      await Navigator.push(
        ...
        RouteGenerator.getRoute(
          ...
          builder: (_) => LockscreenView(
            ...
            biometricsAuthenticationTitle: goTr(context, "View spark view key"),
          ),
    ...
    final xpubData = await showLoading(
      ...
      whileFuture:
          (ref.read(pWallets).getWallet(walletId) as ExtendedKeysInterface)
              .getXPubs(),
      context: context,
      message: goTr(context, "Loading xpubs"),
      ...
      await Navigator.push(
        ...
        RouteGenerator.getRoute(
          ...
          builder: (_) => LockscreenView(
            ...
            biometricsAuthenticationTitle: goTr(context, "View xpub data"),
          ),
        ...
        body: _WalletSettingsViewBody(
          children: [
            SettingsListButton(
              ...
              iconSize: 16,
              title: goTr(context, "Address book"),
              onPressed: () {
                Navigator.of(
                  context,
            ...
            if (coin is FrostCurrency)
              SettingsListButton(
                ...
                iconSize: 16,
                title: goTr(context, "FROST Multisig settings"),
                onPressed: () {
            ...
            if (wallet is EpiccashWallet)
              SettingsListButton(
                iconAssetName: Assets.svg.node,
                iconSize: 16,
                title: goTr(context, "Epicbox Servers"),
                onPressed: () {
                  Navigator.of(
                    context,
              ...
              Consumer(
                builder: (_, ref, __) {
                  return SettingsListButton(
                    ...
                    iconSize: 16,
                    title: goTr(context, "Wallet backup"),
            ...
            SettingsListButton(
              ...
              title: goTr(context, "Wallet settings"),
              iconSize: 16,
              onPressed: () {
                Navigator.of(context).pushNamed(
            ...
            SettingsListButton(
              ...
              title: goTr(context, "Syncing preferences"),
              onPressed: () {
                Navigator.of(
                  context,
              ...
              Consumer(
                builder: (_, ref, __) {
                  return SettingsListButton(
                    ...
                    title: goTr(context, "Wallet xPub"),
            ...
            if (sparkViewKeyEnabled)
              Consumer(
                builder: (_, ref, __) {
                  return SettingsListButton(
                    iconAssetName: Assets.svg.eye,
                    title: goTr(context, "Spark view key"),
            ...
            if (shouldShowClearSparkCache)
              Consumer(
                builder: (_, ref, __) {
                  return SettingsListButton(
                    iconAssetName: Assets.svg.eye,
                    title: goTr(context, "Clear electrumx cache"),
                    onPressed: () async {
                      String? result;
                      ...
                      if (result == "OK" && context.mounted) {
                        await showLoading(
                          ...
                          context: context,
                          message: goTr(context, "Clearing cache..."),
                        );
                      }
                    },
                  );
            ...
            if (coin is NanoCurrency)
              Consumer(
                builder: (_, ref, __) {
                  return SettingsListButton(
                    iconAssetName: Assets.svg.eye,
                    title: goTr(context, "Change representative"),
                    onPressed: () {
                      Navigator.of(context).pushNamed(
      ...
      child: Column(
        ...
        children: [
          TextField(
            ...
            decoration: InputDecoration(hintText: goTr(context, "Host")),
          ),
          const SizedBox(height: 8),
          TextField(
            autocorrect: Util.isDesktop ? false : true,
            ...
            decoration: InputDecoration(hintText: goTr(context, "Port")),
              ...
              try {
                ...
                if (context.mounted) {
                  await showFloatingFlushBar(
                    context: context,
                    message: goTr(context, "Epicbox info saved!"),
                ...
                if (context.mounted) {
                  await showFloatingFlushBar(
                    context: context,
                    message: goTr(context, "Failed to save epicbox info: {0}", [
                      e,
                    ]),
            ...
            onPressed: () async {
              try {
                ...
                if (context.mounted) {
                  await showFloatingFlushBar(
                    context: context,
                    message: goTr(context, "Mwcmqs info saved!"),
                    type: FlushBarType.success,
                  );
                }
                unawaited(wallet.refresh());
                ...
                if (context.mounted) {
                  await showFloatingFlushBar(
                    context: context,
                    message: goTr(context, "Failed to save mwcmqs info: {0}", [
                      e,
                    ]),
                    type: FlushBarType.warning,
                  );
