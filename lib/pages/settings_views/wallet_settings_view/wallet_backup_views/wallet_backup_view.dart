            ...
            if (keyData != null)
              Padding(
                ...
                child: CustomTextButton(
                  text: switch (keyData) {
                    final XPrivData _ => goTr(context, "xpriv(s)"),
                    final CWKeyData _ => goTr(context, "keys"),
                    final ViewOnlyWalletData _ => goTr(context, "keys"),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      ...
      children: [
        ...
        if (AppConfig.appName != "GOwallet")
          PrimaryButton(
            label: goTr(context, "Show QR Code"),
            onPressed: () {
                  ...
                  return StackDialogBase(
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: Text(
                            goTr(context, "Recovery phrase QR code"),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (prevGen)
                    RoundedWhiteContainer(
                      child: Text(
                        goTr(context, "Previous generation info"),
                        style: STextStyles.label(context),
                      ),
                    ),
                  ...
                  if (prevGen)
                    DetailItem(
                      title: goTr(context, "Previous multisig config"),
                  ...
                  if (prevGen)
                    DetailItem(
                      title: goTr(context, "Previous keys"),
