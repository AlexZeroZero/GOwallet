...
final class InitiateResharingView extends ConsumerStatefulWidget {
  const InitiateResharingView({super.key, required this.walletId});
        ...
        builder: (child) => Background(
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                goTr(context, "Initiate resharing"),
                      ...
                      child: Container(
                        ...
                        child: IgnorePointer(
                          child: Row(
                            children: [
                              Checkbox(
                                value: selectedParticipants.contains(
                                  currentParticipantsWithoutMe[i],
                                ),
                                onChanged: (_) {},
                              ),
            ...
            PrimaryButton(
              ...
              onPressed: () async {
                ...
                await Navigator.of(context).pushNamed(
                  ...
                  arguments: (walletId: widget.walletId, resharers: resharers),
                );
              },
            ),
          ],
