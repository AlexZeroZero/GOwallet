    ...
    try {
      ...
      if (frostInfo.knownSalts.contains(salt)) {
        return await showDialog<void>(
          context: context,
          builder: (_) => StackOkDialog(
            title: goTr(context, "Duplicate config salt"),
            desktopPopRootNavigator: Util.isDesktop,
          ),
        );
      } else {
      ...
      child: ConditionalParent(
        ...
        builder: (child) => Background(
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                goTr(context, "Edit group details"),
        ...
        child: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        goTr(context, "I will be a signer in the new config"),
            ...
            Text(
              goTr(context, "New number of participants"),
              style: STextStyles.w500_14(context).copyWith(
                color: Theme.of(
                  context,
                ).extension<StackColors>()!.textSubtitle1,
            ...
            RoundedWhiteContainer(
              child: Text(
                goTr(
                  context,
                  "The number of participants must be equal to or greater than the number of required signatures.",
                ),
                style: STextStyles.w500_12(context).copyWith(
                  color: Theme.of(
                    context,
            ...
            if (controllers.isNotEmpty)
              RoundedWhiteContainer(
                child: Text(
                  goTr(context, "Type each name in one word without spaces."),
                  style: STextStyles.w500_12(context).copyWith(
                    color: Theme.of(
                      context,
                    ).extension<StackColors>()!.textSubtitle2,
            ...
            const SizedBox(height: 16),
            PrimaryButton(
              label: goTr(context, "Generate config"),
              onPressed: () async {
