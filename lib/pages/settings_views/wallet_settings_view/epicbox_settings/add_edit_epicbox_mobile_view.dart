    ...
    if (result != null) {
      unawaited(
        showFloatingFlushBar(
          ...
          message: goTr(context, "Connection successful"),
          context: context,
        ),
      );
    } else {
      unawaited(
        showFloatingFlushBar(
          ...
          message: goTr(context, "Could not connect to server"),
          context: context,
        ),
      );
    }
    ...
    if (!canConnect && mounted) {
      await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          title: Text(goTr(context, "Server currently unreachable")),
          content: Text(
            goTr(context, "Would you like to save this server anyways?"),
          ),
          actions: [
        ...
        appBar: AppBar(
          ...
          title: Text(
            widget.viewType == AddEditEpicboxMobileViewType.add
                ? goTr(context, "Add Epicbox Server")
                : goTr(context, "Edit Epicbox Server"),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SecondaryButton(
                            label: goTr(context, "Test connection"),
