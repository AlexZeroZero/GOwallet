...
class _ChangeRepresentativeViewState
  ...
  Future<void> _save() async {
    ...
    final result = await showLoading(
      ...
      context: context,
      message: goTr(context, "Updating representative..."),
    ...
    if (mounted) {
      if (result != null && result) {
        ...
        await showFloatingFlushBar(
          ...
          message: goTr(context, "Representative changed"),
          context: context,
        );
      }
    }
      ...
      builder: (child) => Background(
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text(
              goTr(context, "Wallet representative"),
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      goTr(context, "Change representative"),
                        ...
                        ConditionalParent(
                          ...
                          child: ConditionalParent(
                            ...
                            builder: (child) => Column(
                              ...
                              children: [
                                Text(
                                  goTr(context, "Current representative"),
                        ...
                        TextField(
                          ...
                          decoration:
                              standardInputDecoration(
                                goTr(context, "Enter new representative"),
                                _textFocusNode,
                                context,
