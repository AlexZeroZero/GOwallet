    ...
    try {
      if (_switchControllerMwebToggle.isOn?.call() != true) {
        final canContinue = await showDialog<bool?>(
          ...
          builder: (context) {
            return StackDialog(
              title: goTr(context, "Notice"),
              message: goTr(
                context,
                "Activating MWEB requires synchronizing on-chain MWEB related data. This currently requires about 800 MB of storage.",
              ),
                      ...
                      child: RawMaterialButton(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                goTr(context, "Reuse receiving address"),
                                style: STextStyles.titleBold12(context),
                      ...
                      child: RawMaterialButton(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                goTr(context, "Enable legacy addresses"),
                                style: STextStyles.titleBold12(context),
                                textAlign: TextAlign.left,
                              ),
                              SizedBox(
                      ...
                      onPressed: () {
                        showDialog<void>(
                          ...
                          builder: (_) => StackDialog(
                            title: goTr(context, "Do you want to delete {0}?", [
