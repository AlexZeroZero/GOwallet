...
class _SendViewState extends ConsumerState<SendView> {
      ...
      builder: (ctx) => SDialog(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              Text(
                goTr(context, "Choose your address"),
  ...
  Future<void> _scanQr() async {
    try {
      ...
      Logging.instance.e("QR scan failed in SendView", error: e, stackTrace: s);
      if (mounted) {
        unawaited(
          showDialog<void>(
            context: context,
            builder: (_) => StackOkDialog(
              title: goTr(context, "Unable to open camera"),
              message: goTr(
                context,
    ...
    try {
      if (mounted) {
        ...
        final slatepackResult = await showLoading(
          ...
          context: context,
          message: goTr(context, "Building slatepack..."),
      ...
      if (mounted) {
        await showDialog<void>(
          ...
          builder: (context) => StackOkDialog(
            title: goTr(context, "Slatepack Creation Failed"),
            message: e.toString(),
          ),
        );
      }
    ...
    try {
      if (mounted) {
        ...
        final slatepackResult = await showLoading(
          whileFuture: wrappedFutureWithDelay(),
          context: context,
          message: goTr(context, "Building slate..."),
          delay: const Duration(seconds: 2),
          onException: (e) => ex = e,
        );
      ...
      if (mounted) {
        await showDialog<void>(
          context: context,
          builder: (context) => StackOkDialog(
            title: goTr(context, "Slate Creation Failed"),
            message: e.toString(),
          ),
        );
      }
      ...
      if (amount == availableBalance) {
        ...
        if (mounted) {
          shouldSendAll = await showDialog<bool>(
            ...
            builder: (context) {
              return StackDialog(
                title: goTr(context, "Confirm send all"),
                message: goTr(
                  context,
  ...
  String _getSendAllTitle(
    ...
    if (showCoinControl && selectedUTXOs.isNotEmpty) {
      return goTr(context, "Send all selected");
    }

    return goTr(context, "发送全部 {0}", [coin.ticker]);
  }
                    ...
                    child: IntrinsicHeight(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            GoNotice(
                              title: goTr(context, "先核对网络，再填写地址"),
                              detail: goTr(
                                context,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        if (isFiro || isMwebEnabled)
                                          Text(
                                            goTr(context, "{0} balance", [
                                              balType.name.capitalize(),
                                            ]),
                            ...
                            if (hasOptionalMemo ||
                              ...
                              TextField(
                                ...
                                decoration:
                                    standardInputDecoration(
                                      goTr(context, "Enter memo (optional)"),
                                      _memoFocus,
                                      context,
                                    ).copyWith(
                                      counterText: '',
                                  ...
                                  child: Tooltip(
                                    ...
                                    child: Text(
                                      goTr(
                                        ...
                                        [ref.watch(pOpReturnData)!.length ~/ 2],
                                      ),
                                      textAlign: TextAlign.left,
                                ...
                                if (_address == null || _address!.isEmpty) {
                                  ...
                                  if (_data != null &&
                                    ...
                                    error = null;
                                      ...
                                      !ref.watch(pValidSparkSendToAddress)) {
                                    error = goTr(context, "Invalid address");
                                  } else {
                                    error = null;
                                  }
                                } else {
                            ...
                            if (ref.watch(pOpReturnData) != null &&
                              ...
                              Padding(
                                ...
                                child: Text(
                                  goTr(
                                    context,
                                    "Bridge data detected but Spark (private) transactions cannot carry OP_RETURN data. Switch to public balance to complete the bridge transaction.",
                                  ),
                                  textAlign: TextAlign.left,
