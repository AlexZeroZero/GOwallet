...
class _MwcSlatepackDialogState extends ConsumerState<MwcSlatepackDialog> {
  void _copySlatepack() {
    ...
    showFloatingFlushBar(
      ...
      message: goTr(context, "Slatepack copied to clipboard"),
  ...
  void _shareSlatepack() {
    ...
    showFloatingFlushBar(
      type: FlushBarType.info,
      message: goTr(context, "Share functionality coming soon"),
      context: context,
    );
  }
