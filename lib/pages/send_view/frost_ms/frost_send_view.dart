    ...
    try {
      ...
      if (mounted) {
        txData = await showLoading<TxData>(
          ...
          context: context,
          message: goTr(context, "Generating sign config"),
      ...
      if (mounted) {
        unawaited(
          showDialog<dynamic>(
            ...
            builder: (context) {
              return StackDialog(
                title: goTr(context, "Create sign config failed"),
                message: e.toString(),
          ...
          children: [
            ...
            if (recipientWidgetIndexes.length > 1)
              SecondaryButton(
                ...
                label: goTr(context, "Add recipient"),
                onPressed: () {
                  // used for tracking recipient forms
                  _greatestWidgetIndex++;
                  recipientWidgetIndexes.add(_greatestWidgetIndex);
            ...
            const SizedBox(height: 12),
            PrimaryButton(
              label: goTr(context, "Create multisig transaction"),
