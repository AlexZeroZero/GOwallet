    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
                        ...
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: goTr(
                                context,
                                "You must have the threshold number of preprocesses (including yours) to send this transaction.",
                              ),
          ...
          DetailItem(
            title: goTr(context, "Threshold"),
            detail: goTr(context, "{0} signatures", [threshold]),
            horizontal: true,
          ),
          const SizedBox(height: 12),
          DetailItem(
            title: goTr(context, "My name"),
            detail: myName,
          ...
          const SizedBox(height: 12),
          DetailItem(
            title: goTr(context, "My preprocess"),
            detail: myPreprocess,
            button: Util.isDesktop
          ...
          RoundedWhiteContainer(
            child: Text(
              goTr(
                context,
                "You need to obtain {0} preprocess from signing members to send this transaction.",
                [threshold - 1],
              ),
          ...
          Builder(
            builder: (context) {
              ...
              return DetailItem(
                title: goTr(context, "Required preprocesses"),
                detail: goTr(context, "{0} of {1}", [count, threshold]),
                horizontal: true,
          ...
          const SizedBox(height: 12),
          PrimaryButton(
            label: goTr(context, "Generate shares"),
                ...
                if (context.mounted) {
                  return await showDialog<void>(
                    ...
                    builder: (_) => FrostErrorDialog(
                      title: goTr(context, "Failed to continue signing"),
                    ),
                  );
                }
              }
