      ...
      if (mounted) {
        await showDialog<void>(
          ...
          builder: (_) => StackOkDialog(
            title: goTr(context, "Import and attempt sign config failed"),
            message: e.toString(),
      ...
      child: Column(
        ...
        children: [
          ...
          FrostStepField(
            ...
            label: goTr(context, "Import sign config"),
            hint: "Enter config",
            onChanged: (_) {
              setState(() {
          ...
          CheckboxTextButton(
            label: goTr(
              context,
              "I have verified that everyone has imported he config and is ready to sign",
            ),
            onChanged: (value) {
              setState(() {
          ...
          const SizedBox(height: 12),
          PrimaryButton(
            label: goTr(context, "Start signing"),
