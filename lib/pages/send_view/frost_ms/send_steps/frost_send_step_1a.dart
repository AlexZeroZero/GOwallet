...
class _FrostSendStep1aState extends ConsumerState<FrostSendStep1a> {
  ...
  Widget build(BuildContext context) {
    final double qrImageSize = Util.isDesktop
        ? 360
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
                ...
                for (int i = 0; i < steps2to4.length; i++)
                  Padding(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${i + 2}.", style: STextStyles.w500_12(context)),
                        const SizedBox(width: 4),
                        Expanded(
                          child: Text(
                            steps2to4[i],
          ...
          SizedBox(height: Util.isDesktop ? 20 : 12),
          DetailItem(
            title: goTr(context, "Encoded transaction config"),
          ...
          DetailItem(
            ...
            detail: goTr(context, "{0} signatures", [_threshold]),
            horizontal: true,
          ),
          SizedBox(height: Util.isDesktop ? 20 : 12),
          ...
          CheckboxTextButton(
            label: goTr(
              context,
              "I have verified that everyone has imported the config and is ready to sign",
            ),
            onChanged: (value) {
              setState(() {
          ...
          SizedBox(height: Util.isDesktop ? 20 : 12),
          PrimaryButton(
            label: goTr(context, "Attempt sign"),
