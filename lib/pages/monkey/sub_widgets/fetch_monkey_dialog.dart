  ...
  Widget build(BuildContext context) {
    if (Util.isDesktop) {
      return DesktopDialog(
        child: Column(
          children: [
            ...
            const Spacer(flex: 2),
            Text(
              goTr(context, "Fetching MonKey"),
              style: STextStyles.desktopH2(context),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 16),
            Text(
              goTr(context, "We are fetching your MonKey"),
      ...
      return WillPopScope(
        ...
        child: StackDialog(
          title: goTr(context, "Fetching MonKey"),
          message: goTr(context, "We are fetching your MonKey"),
