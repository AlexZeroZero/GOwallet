                      ...
                      showDialog<dynamic>(
                        ...
                        builder: (context) {
                          return StackOkDialog(
                            title: goTr(context, "About MonKeys"),
                            message: goTr(
                              context,
                              "A MonKey is a visual representation of your Banano address.",
                            ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        SecondaryButton(
                          label: goTr(context, "Save as SVG"),
                          onPressed: () async {
                            bool didError = false;
                            await showLoading(
                              ...
                              message: goTr(context, "Saving MonKey svg"),
                              onException: (e) {
                                didError = true;
                        ...
                        SecondaryButton(
                          label: goTr(context, "Download as PNG"),
                          onPressed: () async {
                            bool didError = false;
                            await showLoading(
                              whileFuture: Future.wait([
                              ...
                              context: context,
                              rootNavigator: Util.isDesktop,
                              message: goTr(context, "Downloading MonKey png"),
                              onException: (e) {
                                didError = true;
                                String msg = e.toString();
                                while (msg.isNotEmpty &&
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(16.0),
                    child: PrimaryButton(
                      label: goTr(context, "Fetch MonKey"),
                      onPressed: () async {
                        await showLoading(
                          whileFuture: Future.wait([
                            wallet.getCurrentReceivingAddress().then(
                          ...
                          context: context,
                          rootNavigator: Util.isDesktop,
                          message: goTr(context, "Fetching MonKey"),
