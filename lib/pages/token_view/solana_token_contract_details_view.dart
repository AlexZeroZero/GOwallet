      ...
      child: Column(
        ...
        children: [
          ...
          if (token.metadataAddress != null) ...[
            const SizedBox(height: 12),
            _Item(
              title: goTr(context, "Metadata address"),
      ...
      child: Column(
        ...
        children: [
          ...
          data.isNotEmpty
              ...
              : Text(
                  goTr(context, "{0} will appear here", [title]),
