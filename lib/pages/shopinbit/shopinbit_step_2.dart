      ...
      child: ConditionalParent(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              goTr(context, "Select the type of service you need."),
              style: isDesktop
            ...
            _CategoryCard(
              category: .travel,
              title: goTr(context, "Travel"),
              description: goTr(context, "Book flights, hotels, and more."),
            ...
            _CategoryCard(
              category: .car,
              title: goTr(context, "Car"),
              description: goTr(context, "Find and purchase vehicles."),
