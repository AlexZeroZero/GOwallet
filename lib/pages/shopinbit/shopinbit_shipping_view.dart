  ...
  Widget build(BuildContext context) {
    ...
    final content = Column(
      ...
      children: [
        ...
        Text(
          goTr(context, "Where should we deliver your order?"),
          style: isDesktop
          ...
          ClipRRect(
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton2<String>(
                ...
                hint: Text(
                  _loadingCountries
                      ? goTr(context, "Loading countries...")
                      : goTr(context, "Country"),
                  style: isDesktop
                      ? STextStyles.desktopTextExtraSmall(context).copyWith(
                          color: Theme.of(context)
        ...
        PrimaryButton(
          label: _submitting
              ? goTr(context, "Submitting...")
              : goTr(context, "Continue to payment"),
