              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      goTr(context, "Send from {0}", [AppConfig.prefix]),
            ...
            Row(
              children: [
                Text(
                  amount != null
                      ? tokenContract != null
                            ? goTr(context, "You need to send {0} {1}", [
                                amount!.decimal.toStringAsFixed(
                                  tokenContract!.decimals,
                                ),
                                tokenContract!.symbol,
                              ])
                            : goTr(context, "You need to send {0}", [
                                ref
                                    .watch(pAmountFormatter(coin))
                                    .format(amount!),
                              ])
                      : goTr(context, "Select a wallet to pay"),
                  style: isDesktop
    ...
    if (sendAmount == null) {
      if (ref.read(pShopinBitService).client.sandbox) {
        ...
        await showDialog<dynamic>(
          ...
          builder: (context) {
            return StackDialog(
              title: goTr(context, "Transaction failed"),
              message: goTr(context, "Payment amount not available yet"),
