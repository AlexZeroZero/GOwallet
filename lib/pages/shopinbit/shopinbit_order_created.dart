      ...
      child: ConditionalParent(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              goTr(context, "Your request has been submitted."),
              style: isDesktop
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        model.ticketId ?? goTr(context, "N/A"),
                        style: isDesktop
                            ? STextStyles.desktopTextSmall(context)
            ...
            BranchedParent(
              ...
              children: [
                PrimaryButton(
                  label: goTr(context, "View request"),
                ...
                SecondaryButton(
                  label: goTr(context, "Back to services"),
                  buttonHeight: isDesktop ? .l : null,
                  onPressed: () {
                    if (Util.isDesktop) {
