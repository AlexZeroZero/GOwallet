...
class _ShopInBitTravelFormState extends ConsumerState<ShopInBitTravelForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ShopInBitStep4Header(
          title: goTr(context, "Travel request"),
          subtitle: goTr(
            context,
        ...
        ShopInBitStep4Dropdown(
          ...
          items: _arrangements,
          hintText: goTr(context, "Arrangement type"),
        ...
        AdaptiveTextField(
          ...
          labelText: goTr(context, "Destination city"),
        ...
        ShopInBitLabeledCheckbox(
          ...
          label: goTr(context, "I need recommendations"),
        ),

        SizedBox(height: isDesktop ? 24 : 16),
        _TravelSectionLabel(text: goTr(context, "When"), isDesktop: isDesktop),
        SizedBox(height: isDesktop ? 12 : 8),
        ShopInBitStep4Dropdown(
          value: _selectedDateMode,
          items: _dateModes,
          hintText: goTr(context, "Date mode"),
        ...
        if (_selectedDateMode == _exactDates) ...[
          ...
          ShopInBitStep4Dropdown(
            ...
            hintText: goTr(context, "Flexibility"),
        ...
        if (_selectedDateMode == _flexibleDates) ...[
          ...
          AdaptiveTextField(
            ...
            labelText: goTr(context, "Number of nights"),
        ...
        SizedBox(height: isDesktop ? 24 : 16),
        _TravelSectionLabel(text: goTr(context, "Who"), isDesktop: isDesktop),
        SizedBox(height: isDesktop ? 12 : 8),
        ShopInBitTravelerCounter(
          label: goTr(context, "Adults"),
          value: _adults,
          min: 1,
        ...
        SizedBox(height: isDesktop ? 12 : 8),
        ShopInBitTravelerCounter(
          label: goTr(context, "Children"),
          value: _children,
          onChanged: (v) => setState(() => _children = v),
        ),
        SizedBox(height: isDesktop ? 12 : 8),
        ShopInBitTravelerCounter(
          label: goTr(context, "Infants"),
          value: _infants,
          onChanged: (v) => setState(() => _infants = v),
        ),
        SizedBox(height: isDesktop ? 12 : 8),
        ShopInBitTravelerCounter(
          label: goTr(context, "Pets"),
          value: _pets,
        ...
        AdaptiveTextField(
          ...
          labelText: goTr(context, "Minimum 1000 EUR"),
          keyboardType: TextInputType.number,
          inputFormatters: [FilteringTextInputFormatter.digitsOnly],
          suffixText: "EUR",
          autocorrect: false,
