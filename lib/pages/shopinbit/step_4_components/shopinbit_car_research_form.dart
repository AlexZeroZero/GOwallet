      ...
      if (existingPending.isNotEmpty && mounted) {
        final bool? resumePrevious = await showDialog<bool>(
          ...
          builder: (context) => StackDialog(
            ...
            title: goTr(context, "In-Progress Car Research"),
            message: goTr(
              context,
              "You have an unfinished car research payment. Would you like to resume it or start a new search?",
            ),
            leftButton: SecondaryButton(
              label: goTr(context, "New"),
              buttonHeight: Util.isDesktop ? .l : null,
              onPressed: Navigator.of(context).pop,
            ),
            rightButton: PrimaryButton(
              label: goTr(context, "Resume"),
              buttonHeight: Util.isDesktop ? .l : null,
    ...
    return Column(
      ...
      children: [
        ShopInBitStep4Header(
          title: goTr(context, "Car Research request"),
          subtitle: goTr(context, "Tell us about the car you're looking for."),
        ),
        ...
        ShopInBitStep4Dropdown(
          ...
          hintText: goTr(context, "Condition"),
        ...
        AdaptiveTextField(
          ...
          labelText: goTr(context, "Budget (€, minimum 20,000)"),
        ...
        ShopInBitLabeledCheckbox(
          ...
          label: goTr(context, "I acknowledge the €223 research fee"),
        ),
          ...
          Expanded(
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(
                    text: goTr(context, "Research fee: "),
