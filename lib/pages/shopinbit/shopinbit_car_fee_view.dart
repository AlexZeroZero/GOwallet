          ...
          unawaited(
            showFloatingFlushBar(
              ...
              message:
                  ...
                  goTr(context, "Failed to create invoice"),
              context: context,
            ),
          );
        }
    ...
    return ClipRRect(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton2<String>(
          ...
          items: _countries
              .map(
                (c) => DropdownMenuItem<String>(
                  ...
                  child: Text(
                    c[goTr(context, "label")] as String,
                    style: isDesktop
          ...
          hint: Text(
            _loadingCountries ? goTr(context, "Loading countries...") : hint,
            style: isDesktop
                ? STextStyles.desktopTextExtraSmall(context).copyWith(
                    color: Theme.of(
                      context,
    ...
    final content = Column(
      ...
      children: [
        ...
        AdaptiveTextField(
          ...
          labelText: goTr(context, "Full name"),
          autocorrect: false,
        ...
        AdaptiveTextField(
          ...
          labelText: goTr(context, "Street address"),
          autocorrect: false,
          enableSuggestions: false,
          onChanged: (_) => setState(() {}),
        ),
          ...
          children: [
            ...
            Expanded(
              child: AdaptiveTextField(
                ...
                labelText: goTr(context, "Postal code"),
                autocorrect: false,
                enableSuggestions: false,
                onChanged: (_) => setState(() {}),
              ),
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  goTr(context, "Different billing address?"),
                  style: isDesktop
                      ? STextStyles.desktopTextSmall(context)
                      : STextStyles.w500_14(context),
                ),
        ...
        PrimaryButton(
          label: goTr(context, "Pay research fee"),
