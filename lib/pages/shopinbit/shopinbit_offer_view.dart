  ...
  Widget build(BuildContext context) {
    ...
    final content = Column(
      ...
      children: [
        ...
        Text(
          goTr(context, "ShopinBit has found a match for your request."),
          style: isDesktop
        ...
        RoundedWhiteContainer(
          child: Column(
            ...
            children: [
              ...
              Text(
                model.offerProductName ??
                    (_loading
                        ? goTr(context, "Loading...")
                        : goTr(context, "N/A")),
                style: isDesktop
                    ? STextStyles.desktopTextSmall(context)
        ...
        RoundedWhiteContainer(
          child: Column(
            ...
            children: [
              Text(
                goTr(context, "Price (incl. service fee)"),
                style: isDesktop
                    ? STextStyles.desktopTextExtraExtraSmall(context)
                    : STextStyles.itemSubtitle12(context),
              ),
              ...
              Text(
                _loading && model.offerPrice == null
                    ? goTr(context, "Loading...")
                    : goTr(context, "{0} EUR", [model.offerPrice ?? '0']),
                style: isDesktop
                    ? STextStyles.desktopTextSmall(context)
                    : STextStyles.titleBold12(context),
              ),
        ...
        const Spacer(),
        PrimaryButton(
          label: goTr(context, "Accept offer"),
          enabled: !_loading,
          onPressed: () {
