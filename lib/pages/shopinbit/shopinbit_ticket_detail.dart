    ...
    try {
        ...
        if (mounted) {
          ...
          unawaited(
            showFloatingFlushBar(
              ...
              message:
                  reqResp.exception?.message ??
                  goTr(context, "Failed to create request"),
              context: context,
            ),
          );
        }
      ...
      unawaited(
        showFloatingFlushBar(
          ...
          message: goTr(
            context,
            "Car research request submitted successfully!",
          ),
          context: context,
        ),
      );
    ...
    final statusBar = Padding(
      ...
      child: RoundedWhiteContainer(
        ...
        child: Row(
          ...
          children: [
            SelectableText(
              model.ticketId ?? goTr(context, "Request"),
              style: isDesktop
            ...
            child: RoundedWhiteContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                    label: goTr(context, "Review offer"),
                    onPressed: () {
                      if (isDesktop) {
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: goTr(context, "Type a message..."),
                hintStyle: isDesktop
                    ? STextStyles.desktopTextExtraExtraSmall(context)
