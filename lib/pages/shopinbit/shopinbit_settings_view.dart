      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Display name updated"),
            context: context,
          ),
        );
      }
    ...
    try {
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            type: FlushBarType.success,
            message: goTr(context, "Customer key generated"),
            context: context,
          ),
        );
      }
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            ...
            message: goTr(context, "Failed to generate key: {0}", [e]),
            context: context,
          ),
        );
      }
    ...
    try {
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            type: FlushBarType.success,
            message: goTr(context, "Customer key set"),
            context: context,
          ),
        );
      }
      ...
      if (mounted) {
        unawaited(
          showFloatingFlushBar(
            type: FlushBarType.warning,
            message: goTr(context, "Failed to set key: {0}", [e]),
            context: context,
          ),
        );
      }
              ...
              children: [
                Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        goTr(context, "Save your current key"),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        goTr(context, "Your current customer key is:"),
                      ...
                      Text(
                        goTr(
                          context,
                          "Changing your key will disconnect you from existing ShopinBit requests. Make sure you have saved your current key before proceeding.",
                        ),
                        style: STextStyles.desktopTextExtraExtraSmall(context),
                      ),
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: PrimaryButton(
                              label: goTr(context, "I saved my key"),
                              buttonHeight: ButtonHeight.l,
                              onPressed: () => Navigator.of(
                                context,
                                rootNavigator: true,
            ...
            child: Column(
              ...
              children: [
                ...
                SelectableText(
                  goTr(
                    context,
                    "Changing your key will disconnect you from existing ShopinBit conversations. Make sure you have saved your current key before proceeding.",
                  ),
                  style: STextStyles.smallMed14(context),
                ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            goTr(
                              context,
                              "Your customer key identifies you to ShopinBit. Save it to restore access to your conversations on another device. If you change it, you will lose access to existing conversations.",
                            ),
                          ...
                          PrimaryButton(
                            ...
                            label: _currentKey == null
                                ? goTr(context, "Generate key")
                                : goTr(context, "Generate new key"),
                            onPressed: _generate,
                          ),
                          const SizedBox(height: 20),
                          Text(
                            goTr(context, "Restore key"),
                            style: STextStyles.desktopTextSmall(context),
                          ),
                          const SizedBox(height: 8),
                          Text(
                            goTr(
                              context,
                              "Enter a previously saved customer key to restore access to your ShopinBit conversations.",
                            ),
                            style: STextStyles.desktopTextExtraExtraSmall(
                              context,
                            ),
                          ...
                          SizedBox(
                            ...
                            child: AdaptiveTextField(
                              labelText: goTr(context, "Enter customer key"),
                          ...
                          PrimaryButton(
                            ...
                            label: goTr(context, "Set key"),
                            onPressed: _setManualKey,
                          ),
                          const SizedBox(height: 20),
                          Text(
                            goTr(context, "Display Name"),
                            style: STextStyles.desktopTextSmall(context),
                          ),
                          const SizedBox(height: 8),
                          Text(
                            goTr(
                              context,
                              "The name ShopinBit staff will see when communicating with you.",
                            ),
                            style: STextStyles.desktopTextExtraExtraSmall(
                              context,
                            ),
                          ...
                          SizedBox(
                            width: 512,
                            child: AdaptiveTextField(
                              labelText: goTr(context, "Display name"),
        ...
        child: Column(
          ...
          children: [
            Text(
              goTr(
                context,
                "Enter your current customer key to confirm you have saved it.",
              ),
            ...
            Util.isDesktop
                ...
                : const SizedBox(height: 16),
            AdaptiveTextField(
              labelText: goTr(context, "Enter current key"),
