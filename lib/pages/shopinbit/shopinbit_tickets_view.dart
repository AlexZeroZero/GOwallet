    ...
    if (pending == null && !hasTickets) {
      return [
        ...
        Center(
          child: Text(
            _refreshing
                ? goTr(context, "Loading requests...")
                : goTr(context, "No requests yet"),
            style: isDesktop
    ...
    if (pending != null) {
      children.add(
        RoundedContainer(
          ...
          child: _RequestRow(
            title: goTr(context, "Car Research (In Progress)"),
            subtitle: goTr(
              context,
    ...
    for (var i = 0; i < _tickets.length; i++) {
      ...
      children.add(
        RoundedContainer(
          ...
          child: _RequestRow(
            title: ticket.ticketId ?? goTr(context, "N/A"),
            subtitle:
