          ...
          if (mounted) {
            unawaited(
              showFloatingFlushBar(
                ...
                message: goTr(context, "Payment received!"),
                context: context,
              ),
            );
          }
          ...
          if (mounted) {
            unawaited(
              showFloatingFlushBar(
                ...
                message: goTr(context, "Underpaid. Remaining: {0} EUR.", [
                  resp.value!.due ?? '?',
                ]),
                context: context,
              ),
          ...
          if (mounted) {
            unawaited(
              showFloatingFlushBar(
                ...
                message: goTr(context, "No payment detected yet."),
                context: context,
              ),
            );
          }
        ...
        unawaited(
          showFloatingFlushBar(
            ...
            message:
                ...
                goTr(context, "Failed to check payment."),
            context: context,
          ),
        );
      }
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            PrimaryButton(
              label: goTr(context, "CHECK FOR PAYMENT"),
              onPressed: () {
    ...
    final content = Column(
      ...
      children: [
        ...
        RoundedWhiteContainer(
          child: Row(
            ...
            children: [
              ...
              Text(
                goTr(context, "{0} EUR", [_totalPrice]),
                style: isDesktop
                    ? STextStyles.desktopTextSmall(context)
                    : STextStyles.titleBold12(context),
              ),
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    goTr(
                      context,
                      "Payment underpaid. Remaining: {0} EUR. Please send the remaining amount.",
                      [_paymentInfo?.due ?? '?'],
                    ),
                    style:
                        (isDesktop
          ...
          RoundedWhiteContainer(
            child: Column(
              children: [
                ...
                SecondaryButton(
                  label: goTr(context, "Refresh Invoice"),
        ...
        if (_isTerminal) ...[
          ...
          PrimaryButton(
            label: goTr(context, "View My Requests"),
