        ...
        builder: (_) => WillPopScope(
          ...
          child: Container(
            ...
            child: CustomLoadingOverlay(
              message: goTr(context, "Updating exchange rate"),
              eventBus: null,
            ),
          ),
        ),
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            goTr(context, "Choose a coin to exchange"),
    ...
    if (fromCurrency == null || toCurrency == null) {
      await showDialog<void>(
        ...
        builder: (context) => StackOkDialog(
          title: goTr(context, "Missing currency!"),
          message: goTr(
            context,
          ...
          shouldCancel = await showDialog<bool?>(
            ...
            builder: (_) {
              if (isDesktop) {
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            goTr(context, "Failed to update trade estimate"),
                            style: STextStyles.desktopH3(context),
                          ),
                          const DesktopDialogCloseButton(),
                        ],
                      ...
                      const Spacer(),
                      Text(
                        goTr(context, "Do you want to attempt trade anyways?"),
                        style: STextStyles.desktopTextSmall(context),
                      ),
                      const Spacer(flex: 2),
                      Row(
                ...
                return StackDialog(
                  title: goTr(context, "Failed to update trade estimate"),
                  message: goTr(
                    context,
          ...
          children: [
            ...
            ConditionalParent(
              ...
              child: Semantics(
                label: goTr(
                  context,
                  "Swap Button. Reverse The Exchange Currencies.",
                ),
