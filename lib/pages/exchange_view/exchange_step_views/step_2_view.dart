                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  goTr(context, "Recipient Wallet"),
                                  style: STextStyles.smallMed12(context),
                                ),
                                if (AppConfig.isStackCoin(model.receiveTicker))
                                  CustomTextButton(
                                    text: goTr(context, "Choose from {0}", [
                                      AppConfig.prefix,
                                    ]),
                                    onTap: () {
                                      try {
                            ...
                            RoundedWhiteContainer(
                              child: Text(
                                goTr(
                                  context,
                                  "This is the wallet where your {0} will be sent to.",
                                  [model.receiveTicker.toUpperCase()],
                                ),
                            ...
                            if (supportsRefund)
                              Row(
                                ...
                                children: [
                                  Text(
                                    goTr(context, "Refund Wallet (required)"),
                                    style: STextStyles.smallMed12(context),
                                  ),
