        ...
        return StackDialogBase(
          child: Column(
            children: [
              ...
              Center(
                child: Text(
                  goTr(context, "Send {0} to this address", [model.sendTicker]),
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                goTr(context, "Select Firo balance"),
                style: STextStyles.pageTitleH2(context),
              ),
              const SizedBox(height: 32),
              SecondaryButton(
                label: goTr(context, "{0} (private)", [
                  ref
                      .watch(pAmountFormatter(coin))
                      .format(balancePrivate.spendable),
                ]),
                onPressed: () => Navigator.of(context).pop(false),
              ),
              const SizedBox(height: 16),
              SecondaryButton(
                label: goTr(context, "{0} (public)", [
                  ref
                      .watch(pAmountFormatter(coin))
                      .format(balancePublic.spendable),
                ]),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                goTr(context, "Send {0} to the address below", [
                              ...
                              Text(
                                goTr(
                                  context,
                                  "Send {0} to the address below. Once it is received, {1} will send the {2} to the recipient address you provided. You can find this trade details and check its status in the list of trades.",
                                  [
                                    model.sendTicker.toUpperCase(),
                                    model.trade!.exchangeName,
...
class _WarningInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RoundedContainer(
      ...
      child: RichText(
        text: TextSpan(
          text: goTr(context, "You must send at least {0} {1}. ", [
            model.sendAmount.toString(),
            model.sendTicker,
          ]),
          ...
          children: [
            TextSpan(
              text: goTr(
                context,
                "If you send less than {0} {1}, your transaction may not be converted and it may not be refunded.",
