              ...
              child: Column(
                ...
                children: [
                  ...
                  if (showSendFromStackButton)
                    SecondaryButton(
                      label: goTr(context, "Send from {0}", [AppConfig.prefix]),
              ...
              RoundedWhiteContainer(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextButton(
                      text: goTr(context, "View transaction"),
                      onTap: () {
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            goTr(context, "{0} address", [trade.exchangeName]),
                            style: STextStyles.itemSubtitle(context),
                          ),
                          const SizedBox(height: 4),
                          Row(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Text(
                          goTr(context, "Send {0} to this address", [
                            trade.payInCurrency.toUpperCase(),
                          ]),
                          style: STextStyles.itemSubtitle(context),
                        ),
