...
class PriceAPI {
  ...
  getPricesAnd24hChange({required String baseCurrency}) async {
    // GOwallet's supported coins use its timestamp-validated valuation feed.
    // Empty IDs would otherwise fetch an unrelated market list.
    if (_coinIds.isEmpty) return {};
