...
void main(List<String> args) async {
  ...
  await Logging.instance.initialize(
    ...
    level: AppConfig.appName == "GOwallet"
        ? Level.off
        : Prefs.instance.logLevel,
    debugConsoleLevel: AppConfig.appName == "GOwallet"
        ? Level.off
        : (kDebugMode ? Level.trace : null),
  );
...
class _MaterialAppWithThemeState extends ConsumerState<MaterialAppWithTheme>
  ...
  void initState() {
    ...
    if (Platform.isAndroid) {
      unawaited(
        _mobileAppPrivacy?.setFlagSecure(
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      locale: Locale(
        ref.watch(prefsChangeNotifierProvider.select((p) => p.language)) ==
                "English (US)"
            ? "en"
            : "zh",
      ),
      ...
      builder: (context, child) => GoSessionGate(child: child!),
      onGenerateRoute: RouteGenerator.generateRoute,
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF087B63),
          brightness: colorScheme.brightness,
          primary: colorScheme.accentColorBlue,
          surface: colorScheme.background,
          onSurface: colorScheme.textDark,
        ),
        navigationBarTheme: NavigationBarThemeData(
          backgroundColor: colorScheme.background,
          surfaceTintColor: Colors.transparent,
          indicatorColor: colorScheme.accentColorBlue.withValues(alpha: .15),
        ),
