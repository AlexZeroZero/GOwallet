...
[Download v1.0.2](https://github.com/AlexZeroZero/GOwallet/releases/tag/v1.0.2) · [Build](BUILD.md) · [1.0.2 fixes and verification](VERIFICATION-1.0.2.md) · [Security review](SECURITY-REVIEW.md) · [Electrum](ELECTRUM.md)
...
Android package: `org.gowallet.pow`, version `1.0.2+11`, minimum API 24, ARM64/x86_64. The existing GOwallet signing identity is retained for in-place upgrades. Back up first; do not uninstall to upgrade. No iOS or desktop binary is released here.
