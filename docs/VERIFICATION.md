...
> 最新版本：[1.0.3 生物识别修复与 DINGO 验证](VERIFICATION-1.0.3.md)。本次未重新运行查毒或 MobSF，历史结果不能用于新版 APK。

> 历史修复：Isar 加固已在 [1.0.2 安全修复与验证](VERIFICATION-1.0.2.md) 完成并记录；本文保留原版本的历史结果。
